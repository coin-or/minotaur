...
int CDlogdet_nonsmooth(int n, double* Q, double* wneg, double* wpos, double sigma, int maxIter, double* d, int* iter_arr, double* obj_arr, double* time_arr)
{
	int i=0;
	int iter=0;
	int k = 0;
