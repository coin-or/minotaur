...
maximize obj:  - 4*x2 - 8*x7 - 5*x11 - 8*x23 + 23*x27 + 19*x29 - 10*x30 + 2*x33
     ...
     - 28*b115 - 8*b117 - 15*b118 - 23*b119 + 5*x158 - 2*x163 + 200*x171
     + 250*x172 + 200*x173 + 200*x174 + 500*x175 + 350*x176 - 5*b177 - 8*b178
     - 6*b179 - 10*b180 - 6*b181 - 7*b182 - 4*b183 - 5*b184 - 2*b185 - 4*b186;
...
e266: -log(1 + x153) + x155 + b177 <= 1;

e267:    x153 - 10*b177 <= 0;

e268:    x155 - 2.39789527279837*b177 <= 0;

e269: -1.2*log(1 + x154) + x156 + b178 <= 1;

e270:    x154 - 10*b178 <= 0;

e271:    x156 - 2.87747432735804*b178 <= 0;

e272:  - 0.75*x160 + x164 + b179 <= 1;

e273:  - 0.75*x160 + x164 - b179 >= -1;

e274:    x160 - 2.87747432735804*b179 <= 0;

e275:    x164 - 2.15810574551853*b179 <= 0;

e276: -1.5*log(1 + x161) + x165 + b180 <= 1;

e277:    x161 - 2.87747432735804*b180 <= 0;

e278:    x165 - 2.03277599268042*b180 <= 0;

e279:  - x162 + x166 + b181 <= 1;

e280:  - x162 + x166 - b181 >= -1;

e281:  - 0.5*x163 + x166 + b181 <= 1;

e282:  - 0.5*x163 + x166 - b181 >= -1;

e283:    x162 - 2.87747432735804*b181 <= 0;

e284:    x163 - 7*b181 <= 0;

e285:    x166 - 3.5*b181 <= 0;

e286: -1.25*log(1 + x167) + x172 + b182 <= 1;

e287:    x167 - 2.15810574551853*b182 <= 0;

e288:    x172 - 1.43746550029693*b182 <= 0;

e289: -0.9*log(1 + x168) + x173 + b183 <= 1;

e290:    x168 - 2.15810574551853*b183 <= 0;

e291:    x173 - 1.03497516021379*b183 <= 0;

e292: -log(1 + x165) + x174 + b184 <= 1;

e293:    x165 - 2.03277599268042*b184 <= 0;

e294:    x174 - 1.10947836929589*b184 <= 0;

e295:  - 0.9*x169 + x175 + b185 <= 1;

e296:  - 0.9*x169 + x175 - b185 >= -1;

e297:    x169 - 3.5*b185 <= 0;

e298:    x175 - 3.15*b185 <= 0;

e299:  - 0.6*x170 + x176 + b186 <= 1;

e300:  - 0.6*x170 + x176 - b186 >= -1;

e301:    x170 - 3.5*b186 <= 0;

e302:    x176 - 2.1*b186 <= 0;

e303:    b177 + b178 = 1;

e304:  - b179 + b182 + b183 >= 0;

e305:  - b180 + b184 >= 0;

e306:    b177 + b178 - b179 >= 0;

e307:    b177 + b178 - b180 >= 0;

e308:    b177 + b178 - b181 >= 0;
