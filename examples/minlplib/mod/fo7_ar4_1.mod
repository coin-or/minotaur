...
e47:  - 0.5*x60 - 0.125*x62 <= -2;

e48:  - 0.125*x60 - 0.5*x62 <= -2;

e49:  - 0.5*x61 - 0.125*x63 <= -2;

e50:  - 0.125*x61 - 0.5*x63 <= -2;

e51:  - 0.5*x64 - 0.125*x66 <= -2;

e52:  - 0.125*x64 - 0.5*x66 <= -2;

e53:  - 0.333333*x68 - 0.083333*x70 <= -2;

e54:  - 0.117096*x68 - 0.237222*x70 <= -2;

e55:  - 0.666667*x72 - 0.166667*x74 <= -2;

e56:  - 0.166667*x72 - 0.666667*x74 <= -2;

e57:  - 0.666667*x76 - 0.166667*x78 <= -2;

e58:  - 0.166667*x76 - 0.666667*x78 <= -2;

e59:  - 0.666667*x80 - 0.166667*x82 <= -2;

e60:  - 0.166667*x80 - 0.666667*x82 <= -2;
