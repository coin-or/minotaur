...
e2146: (x1490/(1e-6 + b1986) - log(1 + x1474/(1e-6 + b1986)))*(1e-6 + b1986)
        <= 0;

e2147: (x1491/(1e-6 + b1987) - log(1 + x1475/(1e-6 + b1987)))*(1e-6 + b1987)
        <= 0;

e2148: (x1492/(1e-6 + b1988) - log(1 + x1476/(1e-6 + b1988)))*(1e-6 + b1988)
        <= 0;

e2149: (x1493/(1e-6 + b1989) - log(1 + x1477/(1e-6 + b1989)))*(1e-6 + b1989)
        <= 0;
...
e2158:    x1198 - x1474 - x1478 = 0;

e2159:    x1199 - x1475 - x1479 = 0;

e2160:    x1200 - x1476 - x1480 = 0;

e2161:    x1201 - x1477 - x1481 = 0;

e2162:    x1206 - x1490 - x1494 = 0;

e2163:    x1207 - x1491 - x1495 = 0;

e2164:    x1208 - x1492 - x1496 = 0;

e2165:    x1209 - x1493 - x1497 = 0;

e2166:    x1474 - 40*b1986 <= 0;

e2167:    x1475 - 40*b1987 <= 0;

e2168:    x1476 - 40*b1988 <= 0;

e2169:    x1477 - 40*b1989 <= 0;

e2170:    x1478 + 40*b1986 <= 40;

e2171:    x1479 + 40*b1987 <= 40;

e2172:    x1480 + 40*b1988 <= 40;

e2173:    x1481 + 40*b1989 <= 40;

e2174:    x1490 - 3.71357206670431*b1986 <= 0;

e2175:    x1491 - 3.71357206670431*b1987 <= 0;

e2176:    x1492 - 3.71357206670431*b1988 <= 0;

e2177:    x1493 - 3.71357206670431*b1989 <= 0;
...
e2182: (x1498/(1e-6 + b1990) - 1.2*log(1 + x1482/(1e-6 + b1990)))*(1e-6 + b1990
       ) <= 0;

e2183: (x1499/(1e-6 + b1991) - 1.2*log(1 + x1483/(1e-6 + b1991)))*(1e-6 + b1991
       ) <= 0;

e2184: (x1500/(1e-6 + b1992) - 1.2*log(1 + x1484/(1e-6 + b1992)))*(1e-6 + b1992
       ) <= 0;

e2185: (x1501/(1e-6 + b1993) - 1.2*log(1 + x1485/(1e-6 + b1993)))*(1e-6 + b1993
       ) <= 0;
...
e2194:    x1202 - x1482 - x1486 = 0;

e2195:    x1203 - x1483 - x1487 = 0;

e2196:    x1204 - x1484 - x1488 = 0;

e2197:    x1205 - x1485 - x1489 = 0;

e2198:    x1210 - x1498 - x1502 = 0;

e2199:    x1211 - x1499 - x1503 = 0;

e2200:    x1212 - x1500 - x1504 = 0;

e2201:    x1213 - x1501 - x1505 = 0;

e2202:    x1482 - 40*b1990 <= 0;

e2203:    x1483 - 40*b1991 <= 0;

e2204:    x1484 - 40*b1992 <= 0;

e2205:    x1485 - 40*b1993 <= 0;

e2206:    x1486 + 40*b1990 <= 40;

e2207:    x1487 + 40*b1991 <= 40;

e2208:    x1488 + 40*b1992 <= 40;

e2209:    x1489 + 40*b1993 <= 40;

e2210:    x1498 - 4.45628648004517*b1990 <= 0;

e2211:    x1499 - 4.45628648004517*b1991 <= 0;

e2212:    x1500 - 4.45628648004517*b1992 <= 0;

e2213:    x1501 - 4.45628648004517*b1993 <= 0;
...
e2218:  - 0.75*x1506 + x1538 = 0;

e2219:  - 0.75*x1507 + x1539 = 0;

e2220:  - 0.75*x1508 + x1540 = 0;

e2221:  - 0.75*x1509 + x1541 = 0;
...
e2230:    x1226 - x1506 - x1510 = 0;

e2231:    x1227 - x1507 - x1511 = 0;

e2232:    x1228 - x1508 - x1512 = 0;

e2233:    x1229 - x1509 - x1513 = 0;

e2234:    x1242 - x1538 - x1542 = 0;

e2235:    x1243 - x1539 - x1543 = 0;

e2236:    x1244 - x1540 - x1544 = 0;

e2237:    x1245 - x1541 - x1545 = 0;

e2238:    x1506 - 4.45628648004517*b1994 <= 0;

e2239:    x1507 - 4.45628648004517*b1995 <= 0;

e2240:    x1508 - 4.45628648004517*b1996 <= 0;

e2241:    x1509 - 4.45628648004517*b1997 <= 0;
...
e2246:    x1538 - 3.34221486003388*b1994 <= 0;

e2247:    x1539 - 3.34221486003388*b1995 <= 0;

e2248:    x1540 - 3.34221486003388*b1996 <= 0;

e2249:    x1541 - 3.34221486003388*b1997 <= 0;
...
e2254: (x1546/(1e-6 + b1998) - 1.5*log(1 + x1514/(1e-6 + b1998)))*(1e-6 + b1998
       ) <= 0;

e2255: (x1547/(1e-6 + b1999) - 1.5*log(1 + x1515/(1e-6 + b1999)))*(1e-6 + b1999
       ) <= 0;

e2256: (x1548/(1e-6 + b2000) - 1.5*log(1 + x1516/(1e-6 + b2000)))*(1e-6 + b2000
       ) <= 0;

e2257: (x1549/(1e-6 + b2001) - 1.5*log(1 + x1517/(1e-6 + b2001)))*(1e-6 + b2001
       ) <= 0;
...
e2266:    x1230 - x1514 - x1518 = 0;

e2267:    x1231 - x1515 - x1519 = 0;

e2268:    x1232 - x1516 - x1520 = 0;

e2269:    x1233 - x1517 - x1521 = 0;

e2270:    x1246 - x1546 - x1554 = 0;

e2271:    x1247 - x1547 - x1555 = 0;

e2272:    x1248 - x1548 - x1556 = 0;

e2273:    x1249 - x1549 - x1557 = 0;

e2274:    x1514 - 4.45628648004517*b1998 <= 0;

e2275:    x1515 - 4.45628648004517*b1999 <= 0;

e2276:    x1516 - 4.45628648004517*b2000 <= 0;

e2277:    x1517 - 4.45628648004517*b2001 <= 0;
...
e2282:    x1546 - 2.54515263975353*b1998 <= 0;

e2283:    x1547 - 2.54515263975353*b1999 <= 0;

e2284:    x1548 - 2.54515263975353*b2000 <= 0;

e2285:    x1549 - 2.54515263975353*b2001 <= 0;
...
e2294:  - 0.5*x1530 + x1562 = 0;

e2295:  - 0.5*x1531 + x1563 = 0;

e2296:  - 0.5*x1532 + x1564 = 0;

e2297:  - 0.5*x1533 + x1565 = 0;
...
e2310:    x1234 - x1522 - x1526 = 0;

e2311:    x1235 - x1523 - x1527 = 0;

e2312:    x1236 - x1524 - x1528 = 0;

e2313:    x1237 - x1525 - x1529 = 0;

e2314:    x1238 - x1530 - x1534 = 0;

e2315:    x1239 - x1531 - x1535 = 0;

e2316:    x1240 - x1532 - x1536 = 0;

e2317:    x1241 - x1533 - x1537 = 0;

e2318:    x1250 - x1562 - x1566 = 0;

e2319:    x1251 - x1563 - x1567 = 0;

e2320:    x1252 - x1564 - x1568 = 0;

e2321:    x1253 - x1565 - x1569 = 0;

e2322:    x1522 - 4.45628648004517*b2002 <= 0;

e2323:    x1523 - 4.45628648004517*b2003 <= 0;

e2324:    x1524 - 4.45628648004517*b2004 <= 0;

e2325:    x1525 - 4.45628648004517*b2005 <= 0;
...
e2330:    x1530 - 30*b2002 <= 0;

e2331:    x1531 - 30*b2003 <= 0;

e2332:    x1532 - 30*b2004 <= 0;

e2333:    x1533 - 30*b2005 <= 0;

e2334:    x1534 + 30*b2002 <= 30;

e2335:    x1535 + 30*b2003 <= 30;

e2336:    x1536 + 30*b2004 <= 30;

e2337:    x1537 + 30*b2005 <= 30;

e2338:    x1562 - 15*b2002 <= 0;

e2339:    x1563 - 15*b2003 <= 0;

e2340:    x1564 - 15*b2004 <= 0;

e2341:    x1565 - 15*b2005 <= 0;

e2342:    x1566 + 15*b2002 <= 15;

e2343:    x1567 + 15*b2003 <= 15;

e2344:    x1568 + 15*b2004 <= 15;

e2345:    x1569 + 15*b2005 <= 15;

e2346: (x1610/(1e-6 + b2006) - 1.25*log(1 + x1570/(1e-6 + b2006)))*(1e-6 + 
       b2006) <= 0;

e2347: (x1611/(1e-6 + b2007) - 1.25*log(1 + x1571/(1e-6 + b2007)))*(1e-6 + 
       b2007) <= 0;

e2348: (x1612/(1e-6 + b2008) - 1.25*log(1 + x1572/(1e-6 + b2008)))*(1e-6 + 
       b2008) <= 0;

e2349: (x1613/(1e-6 + b2009) - 1.25*log(1 + x1573/(1e-6 + b2009)))*(1e-6 + 
       b2009) <= 0;
...
e2358:    x1254 - x1570 - x1574 = 0;

e2359:    x1255 - x1571 - x1575 = 0;

e2360:    x1256 - x1572 - x1576 = 0;

e2361:    x1257 - x1573 - x1577 = 0;

e2362:    x1274 - x1610 - x1618 = 0;

e2363:    x1275 - x1611 - x1619 = 0;

e2364:    x1276 - x1612 - x1620 = 0;

e2365:    x1277 - x1613 - x1621 = 0;

e2366:    x1570 - 3.34221486003388*b2006 <= 0;

e2367:    x1571 - 3.34221486003388*b2007 <= 0;

e2368:    x1572 - 3.34221486003388*b2008 <= 0;

e2369:    x1573 - 3.34221486003388*b2009 <= 0;
...
e2374:    x1610 - 1.83548069293539*b2006 <= 0;

e2375:    x1611 - 1.83548069293539*b2007 <= 0;

e2376:    x1612 - 1.83548069293539*b2008 <= 0;

e2377:    x1613 - 1.83548069293539*b2009 <= 0;
...
e2382: (x1626/(1e-6 + b2010) - 0.9*log(1 + x1578/(1e-6 + b2010)))*(1e-6 + b2010
       ) <= 0;

e2383: (x1627/(1e-6 + b2011) - 0.9*log(1 + x1579/(1e-6 + b2011)))*(1e-6 + b2011
       ) <= 0;

e2384: (x1628/(1e-6 + b2012) - 0.9*log(1 + x1580/(1e-6 + b2012)))*(1e-6 + b2012
       ) <= 0;

e2385: (x1629/(1e-6 + b2013) - 0.9*log(1 + x1581/(1e-6 + b2013)))*(1e-6 + b2013
       ) <= 0;
...
e2394:    x1258 - x1578 - x1582 = 0;

e2395:    x1259 - x1579 - x1583 = 0;

e2396:    x1260 - x1580 - x1584 = 0;

e2397:    x1261 - x1581 - x1585 = 0;

e2398:    x1278 - x1626 - x1634 = 0;

e2399:    x1279 - x1627 - x1635 = 0;

e2400:    x1280 - x1628 - x1636 = 0;

e2401:    x1281 - x1629 - x1637 = 0;

e2402:    x1578 - 3.34221486003388*b2010 <= 0;

e2403:    x1579 - 3.34221486003388*b2011 <= 0;

e2404:    x1580 - 3.34221486003388*b2012 <= 0;

e2405:    x1581 - 3.34221486003388*b2013 <= 0;
...
e2410:    x1626 - 1.32154609891348*b2010 <= 0;

e2411:    x1627 - 1.32154609891348*b2011 <= 0;

e2412:    x1628 - 1.32154609891348*b2012 <= 0;

e2413:    x1629 - 1.32154609891348*b2013 <= 0;
...
e2418: (x1642/(1e-6 + b2014) - log(1 + x1550/(1e-6 + b2014)))*(1e-6 + b2014)
        <= 0;

e2419: (x1643/(1e-6 + b2015) - log(1 + x1551/(1e-6 + b2015)))*(1e-6 + b2015)
        <= 0;

e2420: (x1644/(1e-6 + b2016) - log(1 + x1552/(1e-6 + b2016)))*(1e-6 + b2016)
        <= 0;

e2421: (x1645/(1e-6 + b2017) - log(1 + x1553/(1e-6 + b2017)))*(1e-6 + b2017)
        <= 0;
...
e2430:    x1246 - x1550 - x1558 = 0;

e2431:    x1247 - x1551 - x1559 = 0;

e2432:    x1248 - x1552 - x1560 = 0;

e2433:    x1249 - x1553 - x1561 = 0;

e2434:    x1282 - x1642 - x1646 = 0;

e2435:    x1283 - x1643 - x1647 = 0;

e2436:    x1284 - x1644 - x1648 = 0;

e2437:    x1285 - x1645 - x1649 = 0;

e2438:    x1550 - 2.54515263975353*b2014 <= 0;

e2439:    x1551 - 2.54515263975353*b2015 <= 0;

e2440:    x1552 - 2.54515263975353*b2016 <= 0;

e2441:    x1553 - 2.54515263975353*b2017 <= 0;
...
e2446:    x1642 - 1.26558121681553*b2014 <= 0;

e2447:    x1643 - 1.26558121681553*b2015 <= 0;

e2448:    x1644 - 1.26558121681553*b2016 <= 0;

e2449:    x1645 - 1.26558121681553*b2017 <= 0;
...
e2454:  - 0.9*x1586 + x1650 = 0;

e2455:  - 0.9*x1587 + x1651 = 0;

e2456:  - 0.9*x1588 + x1652 = 0;

e2457:  - 0.9*x1589 + x1653 = 0;
...
e2466:    x1262 - x1586 - x1590 = 0;

e2467:    x1263 - x1587 - x1591 = 0;

e2468:    x1264 - x1588 - x1592 = 0;

e2469:    x1265 - x1589 - x1593 = 0;

e2470:    x1286 - x1650 - x1654 = 0;

e2471:    x1287 - x1651 - x1655 = 0;

e2472:    x1288 - x1652 - x1656 = 0;

e2473:    x1289 - x1653 - x1657 = 0;

e2474:    x1586 - 15*b2018 <= 0;

e2475:    x1587 - 15*b2019 <= 0;

e2476:    x1588 - 15*b2020 <= 0;

e2477:    x1589 - 15*b2021 <= 0;

e2478:    x1590 + 15*b2018 <= 15;

e2479:    x1591 + 15*b2019 <= 15;

e2480:    x1592 + 15*b2020 <= 15;

e2481:    x1593 + 15*b2021 <= 15;

e2482:    x1650 - 13.5*b2018 <= 0;

e2483:    x1651 - 13.5*b2019 <= 0;

e2484:    x1652 - 13.5*b2020 <= 0;

e2485:    x1653 - 13.5*b2021 <= 0;
...
e2490:  - 0.6*x1594 + x1658 = 0;

e2491:  - 0.6*x1595 + x1659 = 0;

e2492:  - 0.6*x1596 + x1660 = 0;

e2493:  - 0.6*x1597 + x1661 = 0;
...
e2502:    x1266 - x1594 - x1598 = 0;

e2503:    x1267 - x1595 - x1599 = 0;

e2504:    x1268 - x1596 - x1600 = 0;

e2505:    x1269 - x1597 - x1601 = 0;

e2506:    x1290 - x1658 - x1662 = 0;

e2507:    x1291 - x1659 - x1663 = 0;

e2508:    x1292 - x1660 - x1664 = 0;

e2509:    x1293 - x1661 - x1665 = 0;

e2510:    x1594 - 15*b2022 <= 0;

e2511:    x1595 - 15*b2023 <= 0;

e2512:    x1596 - 15*b2024 <= 0;

e2513:    x1597 - 15*b2025 <= 0;

e2514:    x1598 + 15*b2022 <= 15;

e2515:    x1599 + 15*b2023 <= 15;

e2516:    x1600 + 15*b2024 <= 15;

e2517:    x1601 + 15*b2025 <= 15;

e2518:    x1658 - 9*b2022 <= 0;

e2519:    x1659 - 9*b2023 <= 0;

e2520:    x1660 - 9*b2024 <= 0;

e2521:    x1661 - 9*b2025 <= 0;

e2522:    x1662 + 9*b2022 <= 9;

e2523:    x1663 + 9*b2023 <= 9;

e2524:    x1664 + 9*b2024 <= 9;

e2525:    x1665 + 9*b2025 <= 9;

e2526: (x1666/(1e-6 + b2026) - 1.1*log(1 + x1602/(1e-6 + b2026)))*(1e-6 + b2026
       ) <= 0;

e2527: (x1667/(1e-6 + b2027) - 1.1*log(1 + x1603/(1e-6 + b2027)))*(1e-6 + b2027
       ) <= 0;

e2528: (x1668/(1e-6 + b2028) - 1.1*log(1 + x1604/(1e-6 + b2028)))*(1e-6 + b2028
       ) <= 0;

e2529: (x1669/(1e-6 + b2029) - 1.1*log(1 + x1605/(1e-6 + b2029)))*(1e-6 + b2029
       ) <= 0;
...
e2538:    x1270 - x1602 - x1606 = 0;

e2539:    x1271 - x1603 - x1607 = 0;

e2540:    x1272 - x1604 - x1608 = 0;

e2541:    x1273 - x1605 - x1609 = 0;

e2542:    x1294 - x1666 - x1670 = 0;

e2543:    x1295 - x1667 - x1671 = 0;

e2544:    x1296 - x1668 - x1672 = 0;

e2545:    x1297 - x1669 - x1673 = 0;

e2546:    x1602 - 15*b2026 <= 0;

e2547:    x1603 - 15*b2027 <= 0;

e2548:    x1604 - 15*b2028 <= 0;

e2549:    x1605 - 15*b2029 <= 0;

e2550:    x1606 + 15*b2026 <= 15;

e2551:    x1607 + 15*b2027 <= 15;

e2552:    x1608 + 15*b2028 <= 15;

e2553:    x1609 + 15*b2029 <= 15;

e2554:    x1666 - 3.04984759446376*b2026 <= 0;

e2555:    x1667 - 3.04984759446376*b2027 <= 0;

e2556:    x1668 - 3.04984759446376*b2028 <= 0;

e2557:    x1669 - 3.04984759446376*b2029 <= 0;
...
e2562:  - 0.9*x1614 + x1746 = 0;

e2563:  - 0.9*x1615 + x1747 = 0;

e2564:  - 0.9*x1616 + x1748 = 0;

e2565:  - 0.9*x1617 + x1749 = 0;
...
e2582:    x1274 - x1614 - x1622 = 0;

e2583:    x1275 - x1615 - x1623 = 0;

e2584:    x1276 - x1616 - x1624 = 0;

e2585:    x1277 - x1617 - x1625 = 0;

e2586:    x1306 - x1690 - x1694 = 0;

e2587:    x1307 - x1691 - x1695 = 0;

e2588:    x1308 - x1692 - x1696 = 0;

e2589:    x1309 - x1693 - x1697 = 0;

e2590:    x1338 - x1746 - x1750 = 0;

e2591:    x1339 - x1747 - x1751 = 0;

e2592:    x1340 - x1748 - x1752 = 0;

e2593:    x1341 - x1749 - x1753 = 0;

e2594:    x1614 - 1.83548069293539*b2030 <= 0;

e2595:    x1615 - 1.83548069293539*b2031 <= 0;

e2596:    x1616 - 1.83548069293539*b2032 <= 0;

e2597:    x1617 - 1.83548069293539*b2033 <= 0;
...
e2602:    x1690 - 20*b2030 <= 0;

e2603:    x1691 - 20*b2031 <= 0;

e2604:    x1692 - 20*b2032 <= 0;

e2605:    x1693 - 20*b2033 <= 0;

e2606:    x1694 + 20*b2030 <= 20;

e2607:    x1695 + 20*b2031 <= 20;

e2608:    x1696 + 20*b2032 <= 20;

e2609:    x1697 + 20*b2033 <= 20;

e2610:    x1746 - 20*b2030 <= 0;

e2611:    x1747 - 20*b2031 <= 0;

e2612:    x1748 - 20*b2032 <= 0;

e2613:    x1749 - 20*b2033 <= 0;

e2614:    x1750 + 20*b2030 <= 20;

e2615:    x1751 + 20*b2031 <= 20;

e2616:    x1752 + 20*b2032 <= 20;

e2617:    x1753 + 20*b2033 <= 20;

e2618: (x1754/(1e-6 + b2034) - log(1 + x1630/(1e-6 + b2034)))*(1e-6 + b2034)
        <= 0;

e2619: (x1755/(1e-6 + b2035) - log(1 + x1631/(1e-6 + b2035)))*(1e-6 + b2035)
        <= 0;

e2620: (x1756/(1e-6 + b2036) - log(1 + x1632/(1e-6 + b2036)))*(1e-6 + b2036)
        <= 0;

e2621: (x1757/(1e-6 + b2037) - log(1 + x1633/(1e-6 + b2037)))*(1e-6 + b2037)
        <= 0;
...
e2630:    x1278 - x1630 - x1638 = 0;

e2631:    x1279 - x1631 - x1639 = 0;

e2632:    x1280 - x1632 - x1640 = 0;

e2633:    x1281 - x1633 - x1641 = 0;

e2634:    x1342 - x1754 - x1758 = 0;

e2635:    x1343 - x1755 - x1759 = 0;

e2636:    x1344 - x1756 - x1760 = 0;

e2637:    x1345 - x1757 - x1761 = 0;

e2638:    x1630 - 1.32154609891348*b2034 <= 0;

e2639:    x1631 - 1.32154609891348*b2035 <= 0;

e2640:    x1632 - 1.32154609891348*b2036 <= 0;

e2641:    x1633 - 1.32154609891348*b2037 <= 0;
...
e2646:    x1754 - 0.842233385663186*b2034 <= 0;

e2647:    x1755 - 0.842233385663186*b2035 <= 0;

e2648:    x1756 - 0.842233385663186*b2036 <= 0;

e2649:    x1757 - 0.842233385663186*b2037 <= 0;
...
e2654: (x1762/(1e-6 + b2038) - 0.7*log(1 + x1674/(1e-6 + b2038)))*(1e-6 + b2038
       ) <= 0;

e2655: (x1763/(1e-6 + b2039) - 0.7*log(1 + x1675/(1e-6 + b2039)))*(1e-6 + b2039
       ) <= 0;

e2656: (x1764/(1e-6 + b2040) - 0.7*log(1 + x1676/(1e-6 + b2040)))*(1e-6 + b2040
       ) <= 0;

e2657: (x1765/(1e-6 + b2041) - 0.7*log(1 + x1677/(1e-6 + b2041)))*(1e-6 + b2041
       ) <= 0;
...
e2666:    x1298 - x1674 - x1678 = 0;

e2667:    x1299 - x1675 - x1679 = 0;

e2668:    x1300 - x1676 - x1680 = 0;

e2669:    x1301 - x1677 - x1681 = 0;

e2670:    x1346 - x1762 - x1766 = 0;

e2671:    x1347 - x1763 - x1767 = 0;

e2672:    x1348 - x1764 - x1768 = 0;

e2673:    x1349 - x1765 - x1769 = 0;

e2674:    x1674 - 1.26558121681553*b2038 <= 0;

e2675:    x1675 - 1.26558121681553*b2039 <= 0;

e2676:    x1676 - 1.26558121681553*b2040 <= 0;

e2677:    x1677 - 1.26558121681553*b2041 <= 0;
...
e2682:    x1762 - 0.572481933717686*b2038 <= 0;

e2683:    x1763 - 0.572481933717686*b2039 <= 0;

e2684:    x1764 - 0.572481933717686*b2040 <= 0;

e2685:    x1765 - 0.572481933717686*b2041 <= 0;
...
e2690: (x1770/(1e-6 + b2042) - 0.65*log(1 + x1682/(1e-6 + b2042)))*(1e-6 + 
       b2042) <= 0;

e2691: (x1771/(1e-6 + b2043) - 0.65*log(1 + x1683/(1e-6 + b2043)))*(1e-6 + 
       b2043) <= 0;

e2692: (x1772/(1e-6 + b2044) - 0.65*log(1 + x1684/(1e-6 + b2044)))*(1e-6 + 
       b2044) <= 0;

e2693: (x1773/(1e-6 + b2045) - 0.65*log(1 + x1685/(1e-6 + b2045)))*(1e-6 + 
       b2045) <= 0;

e2694: (x1770/(1e-6 + b2042) - 0.65*log(1 + x1698/(1e-6 + b2042)))*(1e-6 + 
       b2042) <= 0;

e2695: (x1771/(1e-6 + b2043) - 0.65*log(1 + x1699/(1e-6 + b2043)))*(1e-6 + 
       b2043) <= 0;

e2696: (x1772/(1e-6 + b2044) - 0.65*log(1 + x1700/(1e-6 + b2044)))*(1e-6 + 
       b2044) <= 0;

e2697: (x1773/(1e-6 + b2045) - 0.65*log(1 + x1701/(1e-6 + b2045)))*(1e-6 + 
       b2045) <= 0;
...
e2710:    x1302 - x1682 - x1686 = 0;

e2711:    x1303 - x1683 - x1687 = 0;

e2712:    x1304 - x1684 - x1688 = 0;

e2713:    x1305 - x1685 - x1689 = 0;

e2714:    x1314 - x1698 - x1702 = 0;

e2715:    x1315 - x1699 - x1703 = 0;

e2716:    x1316 - x1700 - x1704 = 0;

e2717:    x1317 - x1701 - x1705 = 0;

e2718:    x1350 - x1770 - x1774 = 0;

e2719:    x1351 - x1771 - x1775 = 0;

e2720:    x1352 - x1772 - x1776 = 0;

e2721:    x1353 - x1773 - x1777 = 0;

e2722:    x1682 - 1.26558121681553*b2042 <= 0;

e2723:    x1683 - 1.26558121681553*b2043 <= 0;

e2724:    x1684 - 1.26558121681553*b2044 <= 0;

e2725:    x1685 - 1.26558121681553*b2045 <= 0;
...
e2730:    x1698 - 33.5*b2042 <= 0;

e2731:    x1699 - 33.5*b2043 <= 0;

e2732:    x1700 - 33.5*b2044 <= 0;

e2733:    x1701 - 33.5*b2045 <= 0;
...
e2738:    x1770 - 2.30162356062425*b2042 <= 0;

e2739:    x1771 - 2.30162356062425*b2043 <= 0;

e2740:    x1772 - 2.30162356062425*b2044 <= 0;

e2741:    x1773 - 2.30162356062425*b2045 <= 0;
...
e2758:    x1318 - x1706 - x1710 = 0;

e2759:    x1319 - x1707 - x1711 = 0;

e2760:    x1320 - x1708 - x1712 = 0;

e2761:    x1321 - x1709 - x1713 = 0;

e2762:    x1354 - x1778 - x1782 = 0;

e2763:    x1355 - x1779 - x1783 = 0;

e2764:    x1356 - x1780 - x1784 = 0;

e2765:    x1357 - x1781 - x1785 = 0;

e2766:    x1706 - 9*b2046 <= 0;

e2767:    x1707 - 9*b2047 <= 0;

e2768:    x1708 - 9*b2048 <= 0;

e2769:    x1709 - 9*b2049 <= 0;

e2770:    x1710 + 9*b2046 <= 9;

e2771:    x1711 + 9*b2047 <= 9;

e2772:    x1712 + 9*b2048 <= 9;

e2773:    x1713 + 9*b2049 <= 9;

e2774:    x1778 - 9*b2046 <= 0;

e2775:    x1779 - 9*b2047 <= 0;

e2776:    x1780 - 9*b2048 <= 0;

e2777:    x1781 - 9*b2049 <= 0;

e2778:    x1782 + 9*b2046 <= 9;

e2779:    x1783 + 9*b2047 <= 9;

e2780:    x1784 + 9*b2048 <= 9;

e2781:    x1785 + 9*b2049 <= 9;
...
e2794:    x1322 - x1714 - x1718 = 0;

e2795:    x1323 - x1715 - x1719 = 0;

e2796:    x1324 - x1716 - x1720 = 0;

e2797:    x1325 - x1717 - x1721 = 0;

e2798:    x1358 - x1786 - x1790 = 0;

e2799:    x1359 - x1787 - x1791 = 0;

e2800:    x1360 - x1788 - x1792 = 0;

e2801:    x1361 - x1789 - x1793 = 0;

e2802:    x1714 - 9*b2050 <= 0;

e2803:    x1715 - 9*b2051 <= 0;

e2804:    x1716 - 9*b2052 <= 0;

e2805:    x1717 - 9*b2053 <= 0;

e2806:    x1718 + 9*b2050 <= 9;

e2807:    x1719 + 9*b2051 <= 9;

e2808:    x1720 + 9*b2052 <= 9;

e2809:    x1721 + 9*b2053 <= 9;

e2810:    x1786 - 9*b2050 <= 0;

e2811:    x1787 - 9*b2051 <= 0;

e2812:    x1788 - 9*b2052 <= 0;

e2813:    x1789 - 9*b2053 <= 0;

e2814:    x1790 + 9*b2050 <= 9;

e2815:    x1791 + 9*b2051 <= 9;

e2816:    x1792 + 9*b2052 <= 9;

e2817:    x1793 + 9*b2053 <= 9;

e2818: (x1794/(1e-6 + b2054) - 0.75*log(1 + x1722/(1e-6 + b2054)))*(1e-6 + 
       b2054) <= 0;

e2819: (x1795/(1e-6 + b2055) - 0.75*log(1 + x1723/(1e-6 + b2055)))*(1e-6 + 
       b2055) <= 0;

e2820: (x1796/(1e-6 + b2056) - 0.75*log(1 + x1724/(1e-6 + b2056)))*(1e-6 + 
       b2056) <= 0;

e2821: (x1797/(1e-6 + b2057) - 0.75*log(1 + x1725/(1e-6 + b2057)))*(1e-6 + 
       b2057) <= 0;
...
e2830:    x1326 - x1722 - x1726 = 0;

e2831:    x1327 - x1723 - x1727 = 0;

e2832:    x1328 - x1724 - x1728 = 0;

e2833:    x1329 - x1725 - x1729 = 0;

e2834:    x1362 - x1794 - x1798 = 0;

e2835:    x1363 - x1795 - x1799 = 0;

e2836:    x1364 - x1796 - x1800 = 0;

e2837:    x1365 - x1797 - x1801 = 0;

e2838:    x1722 - 3.04984759446376*b2054 <= 0;

e2839:    x1723 - 3.04984759446376*b2055 <= 0;

e2840:    x1724 - 3.04984759446376*b2056 <= 0;

e2841:    x1725 - 3.04984759446376*b2057 <= 0;
...
e2846:    x1794 - 1.04900943706034*b2054 <= 0;

e2847:    x1795 - 1.04900943706034*b2055 <= 0;

e2848:    x1796 - 1.04900943706034*b2056 <= 0;

e2849:    x1797 - 1.04900943706034*b2057 <= 0;
...
e2854: (x1802/(1e-6 + b2058) - 0.8*log(1 + x1730/(1e-6 + b2058)))*(1e-6 + b2058
       ) <= 0;

e2855: (x1803/(1e-6 + b2059) - 0.8*log(1 + x1731/(1e-6 + b2059)))*(1e-6 + b2059
       ) <= 0;

e2856: (x1804/(1e-6 + b2060) - 0.8*log(1 + x1732/(1e-6 + b2060)))*(1e-6 + b2060
       ) <= 0;

e2857: (x1805/(1e-6 + b2061) - 0.8*log(1 + x1733/(1e-6 + b2061)))*(1e-6 + b2061
       ) <= 0;
...
e2866:    x1330 - x1730 - x1734 = 0;

e2867:    x1331 - x1731 - x1735 = 0;

e2868:    x1332 - x1732 - x1736 = 0;

e2869:    x1333 - x1733 - x1737 = 0;

e2870:    x1366 - x1802 - x1806 = 0;

e2871:    x1367 - x1803 - x1807 = 0;

e2872:    x1368 - x1804 - x1808 = 0;

e2873:    x1369 - x1805 - x1809 = 0;

e2874:    x1730 - 3.04984759446376*b2058 <= 0;

e2875:    x1731 - 3.04984759446376*b2059 <= 0;

e2876:    x1732 - 3.04984759446376*b2060 <= 0;

e2877:    x1733 - 3.04984759446376*b2061 <= 0;
...
e2882:    x1802 - 1.11894339953103*b2058 <= 0;

e2883:    x1803 - 1.11894339953103*b2059 <= 0;

e2884:    x1804 - 1.11894339953103*b2060 <= 0;

e2885:    x1805 - 1.11894339953103*b2061 <= 0;
...
e2890: (x1810/(1e-6 + b2062) - 0.85*log(1 + x1738/(1e-6 + b2062)))*(1e-6 + 
       b2062) <= 0;

e2891: (x1811/(1e-6 + b2063) - 0.85*log(1 + x1739/(1e-6 + b2063)))*(1e-6 + 
       b2063) <= 0;

e2892: (x1812/(1e-6 + b2064) - 0.85*log(1 + x1740/(1e-6 + b2064)))*(1e-6 + 
       b2064) <= 0;

e2893: (x1813/(1e-6 + b2065) - 0.85*log(1 + x1741/(1e-6 + b2065)))*(1e-6 + 
       b2065) <= 0;
...
e2902:    x1334 - x1738 - x1742 = 0;

e2903:    x1335 - x1739 - x1743 = 0;

e2904:    x1336 - x1740 - x1744 = 0;

e2905:    x1337 - x1741 - x1745 = 0;

e2906:    x1370 - x1810 - x1814 = 0;

e2907:    x1371 - x1811 - x1815 = 0;

e2908:    x1372 - x1812 - x1816 = 0;

e2909:    x1373 - x1813 - x1817 = 0;

e2910:    x1738 - 3.04984759446376*b2062 <= 0;

e2911:    x1739 - 3.04984759446376*b2063 <= 0;

e2912:    x1740 - 3.04984759446376*b2064 <= 0;

e2913:    x1741 - 3.04984759446376*b2065 <= 0;
...
e2918:    x1810 - 1.18887736200171*b2062 <= 0;

e2919:    x1811 - 1.18887736200171*b2063 <= 0;

e2920:    x1812 - 1.18887736200171*b2064 <= 0;

e2921:    x1813 - 1.18887736200171*b2065 <= 0;
...
e2926: (x1834/(1e-6 + b2066) - log(1 + x1818/(1e-6 + b2066)))*(1e-6 + b2066)
        <= 0;

e2927: (x1835/(1e-6 + b2067) - log(1 + x1819/(1e-6 + b2067)))*(1e-6 + b2067)
        <= 0;

e2928: (x1836/(1e-6 + b2068) - log(1 + x1820/(1e-6 + b2068)))*(1e-6 + b2068)
        <= 0;

e2929: (x1837/(1e-6 + b2069) - log(1 + x1821/(1e-6 + b2069)))*(1e-6 + b2069)
        <= 0;
...
e2938:    x1378 - x1818 - x1822 = 0;

e2939:    x1379 - x1819 - x1823 = 0;

e2940:    x1380 - x1820 - x1824 = 0;

e2941:    x1381 - x1821 - x1825 = 0;

e2942:    x1386 - x1834 - x1838 = 0;

e2943:    x1387 - x1835 - x1839 = 0;

e2944:    x1388 - x1836 - x1840 = 0;

e2945:    x1389 - x1837 - x1841 = 0;

e2946:    x1818 - 1.18887736200171*b2066 <= 0;

e2947:    x1819 - 1.18887736200171*b2067 <= 0;

e2948:    x1820 - 1.18887736200171*b2068 <= 0;

e2949:    x1821 - 1.18887736200171*b2069 <= 0;
...
e2954:    x1834 - 0.78338879230327*b2066 <= 0;

e2955:    x1835 - 0.78338879230327*b2067 <= 0;

e2956:    x1836 - 0.78338879230327*b2068 <= 0;

e2957:    x1837 - 0.78338879230327*b2069 <= 0;
...
e2962: (x1842/(1e-6 + b2070) - 1.2*log(1 + x1826/(1e-6 + b2070)))*(1e-6 + b2070
       ) <= 0;

e2963: (x1843/(1e-6 + b2071) - 1.2*log(1 + x1827/(1e-6 + b2071)))*(1e-6 + b2071
       ) <= 0;

e2964: (x1844/(1e-6 + b2072) - 1.2*log(1 + x1828/(1e-6 + b2072)))*(1e-6 + b2072
       ) <= 0;

e2965: (x1845/(1e-6 + b2073) - 1.2*log(1 + x1829/(1e-6 + b2073)))*(1e-6 + b2073
       ) <= 0;
...
e2974:    x1382 - x1826 - x1830 = 0;

e2975:    x1383 - x1827 - x1831 = 0;

e2976:    x1384 - x1828 - x1832 = 0;

e2977:    x1385 - x1829 - x1833 = 0;

e2978:    x1390 - x1842 - x1846 = 0;

e2979:    x1391 - x1843 - x1847 = 0;

e2980:    x1392 - x1844 - x1848 = 0;

e2981:    x1393 - x1845 - x1849 = 0;

e2982:    x1826 - 1.18887736200171*b2070 <= 0;

e2983:    x1827 - 1.18887736200171*b2071 <= 0;

e2984:    x1828 - 1.18887736200171*b2072 <= 0;

e2985:    x1829 - 1.18887736200171*b2073 <= 0;
...
e2990:    x1842 - 0.940066550763924*b2070 <= 0;

e2991:    x1843 - 0.940066550763924*b2071 <= 0;

e2992:    x1844 - 0.940066550763924*b2072 <= 0;

e2993:    x1845 - 0.940066550763924*b2073 <= 0;
...
e2998:  - 0.75*x1850 + x1882 = 0;

e2999:  - 0.75*x1851 + x1883 = 0;

e3000:  - 0.75*x1852 + x1884 = 0;

e3001:  - 0.75*x1853 + x1885 = 0;
...
e3010:    x1406 - x1850 - x1854 = 0;

e3011:    x1407 - x1851 - x1855 = 0;

e3012:    x1408 - x1852 - x1856 = 0;

e3013:    x1409 - x1853 - x1857 = 0;

e3014:    x1422 - x1882 - x1886 = 0;

e3015:    x1423 - x1883 - x1887 = 0;

e3016:    x1424 - x1884 - x1888 = 0;

e3017:    x1425 - x1885 - x1889 = 0;

e3018:    x1850 - 0.940066550763924*b2074 <= 0;

e3019:    x1851 - 0.940066550763924*b2075 <= 0;

e3020:    x1852 - 0.940066550763924*b2076 <= 0;

e3021:    x1853 - 0.940066550763924*b2077 <= 0;
...
e3026:    x1882 - 0.705049913072943*b2074 <= 0;

e3027:    x1883 - 0.705049913072943*b2075 <= 0;

e3028:    x1884 - 0.705049913072943*b2076 <= 0;

e3029:    x1885 - 0.705049913072943*b2077 <= 0;
...
e3034: (x1890/(1e-6 + b2078) - 1.5*log(1 + x1858/(1e-6 + b2078)))*(1e-6 + b2078
       ) <= 0;

e3035: (x1891/(1e-6 + b2079) - 1.5*log(1 + x1859/(1e-6 + b2079)))*(1e-6 + b2079
       ) <= 0;

e3036: (x1892/(1e-6 + b2080) - 1.5*log(1 + x1860/(1e-6 + b2080)))*(1e-6 + b2080
       ) <= 0;

e3037: (x1893/(1e-6 + b2081) - 1.5*log(1 + x1861/(1e-6 + b2081)))*(1e-6 + b2081
       ) <= 0;
...
e3046:    x1410 - x1858 - x1862 = 0;

e3047:    x1411 - x1859 - x1863 = 0;

e3048:    x1412 - x1860 - x1864 = 0;

e3049:    x1413 - x1861 - x1865 = 0;

e3050:    x1426 - x1890 - x1898 = 0;

e3051:    x1427 - x1891 - x1899 = 0;

e3052:    x1428 - x1892 - x1900 = 0;

e3053:    x1429 - x1893 - x1901 = 0;

e3054:    x1858 - 0.940066550763924*b2078 <= 0;

e3055:    x1859 - 0.940066550763924*b2079 <= 0;

e3056:    x1860 - 0.940066550763924*b2080 <= 0;

e3057:    x1861 - 0.940066550763924*b2081 <= 0;
...
e3062:    x1890 - 0.994083415506506*b2078 <= 0;

e3063:    x1891 - 0.994083415506506*b2079 <= 0;

e3064:    x1892 - 0.994083415506506*b2080 <= 0;

e3065:    x1893 - 0.994083415506506*b2081 <= 0;
...
e3074:  - 0.5*x1874 + x1906 = 0;

e3075:  - 0.5*x1875 + x1907 = 0;

e3076:  - 0.5*x1876 + x1908 = 0;

e3077:  - 0.5*x1877 + x1909 = 0;
...
e3090:    x1414 - x1866 - x1870 = 0;

e3091:    x1415 - x1867 - x1871 = 0;

e3092:    x1416 - x1868 - x1872 = 0;

e3093:    x1417 - x1869 - x1873 = 0;

e3094:    x1418 - x1874 - x1878 = 0;

e3095:    x1419 - x1875 - x1879 = 0;

e3096:    x1420 - x1876 - x1880 = 0;

e3097:    x1421 - x1877 - x1881 = 0;

e3098:    x1430 - x1906 - x1910 = 0;

e3099:    x1431 - x1907 - x1911 = 0;

e3100:    x1432 - x1908 - x1912 = 0;

e3101:    x1433 - x1909 - x1913 = 0;

e3102:    x1866 - 0.940066550763924*b2082 <= 0;

e3103:    x1867 - 0.940066550763924*b2083 <= 0;

e3104:    x1868 - 0.940066550763924*b2084 <= 0;

e3105:    x1869 - 0.940066550763924*b2085 <= 0;
...
e3110:    x1874 - 30*b2082 <= 0;

e3111:    x1875 - 30*b2083 <= 0;

e3112:    x1876 - 30*b2084 <= 0;

e3113:    x1877 - 30*b2085 <= 0;

e3114:    x1878 + 30*b2082 <= 30;

e3115:    x1879 + 30*b2083 <= 30;

e3116:    x1880 + 30*b2084 <= 30;

e3117:    x1881 + 30*b2085 <= 30;

e3118:    x1906 - 15*b2082 <= 0;

e3119:    x1907 - 15*b2083 <= 0;

e3120:    x1908 - 15*b2084 <= 0;

e3121:    x1909 - 15*b2085 <= 0;

e3122:    x1910 + 15*b2082 <= 15;

e3123:    x1911 + 15*b2083 <= 15;

e3124:    x1912 + 15*b2084 <= 15;

e3125:    x1913 + 15*b2085 <= 15;

e3126: (x1946/(1e-6 + b2086) - 1.25*log(1 + x1914/(1e-6 + b2086)))*(1e-6 + 
       b2086) <= 0;

e3127: (x1947/(1e-6 + b2087) - 1.25*log(1 + x1915/(1e-6 + b2087)))*(1e-6 + 
       b2087) <= 0;

e3128: (x1948/(1e-6 + b2088) - 1.25*log(1 + x1916/(1e-6 + b2088)))*(1e-6 + 
       b2088) <= 0;

e3129: (x1949/(1e-6 + b2089) - 1.25*log(1 + x1917/(1e-6 + b2089)))*(1e-6 + 
       b2089) <= 0;
...
e3138:    x1434 - x1914 - x1918 = 0;

e3139:    x1435 - x1915 - x1919 = 0;

e3140:    x1436 - x1916 - x1920 = 0;

e3141:    x1437 - x1917 - x1921 = 0;

e3142:    x1454 - x1946 - x1950 = 0;

e3143:    x1455 - x1947 - x1951 = 0;

e3144:    x1456 - x1948 - x1952 = 0;

e3145:    x1457 - x1949 - x1953 = 0;

e3146:    x1914 - 0.705049913072943*b2086 <= 0;

e3147:    x1915 - 0.705049913072943*b2087 <= 0;

e3148:    x1916 - 0.705049913072943*b2088 <= 0;

e3149:    x1917 - 0.705049913072943*b2089 <= 0;
...
e3154:    x1946 - 0.666992981045719*b2086 <= 0;

e3155:    x1947 - 0.666992981045719*b2087 <= 0;

e3156:    x1948 - 0.666992981045719*b2088 <= 0;

e3157:    x1949 - 0.666992981045719*b2089 <= 0;
...
e3162: (x1954/(1e-6 + b2090) - 0.9*log(1 + x1922/(1e-6 + b2090)))*(1e-6 + b2090
       ) <= 0;

e3163: (x1955/(1e-6 + b2091) - 0.9*log(1 + x1923/(1e-6 + b2091)))*(1e-6 + b2091
       ) <= 0;

e3164: (x1956/(1e-6 + b2092) - 0.9*log(1 + x1924/(1e-6 + b2092)))*(1e-6 + b2092
       ) <= 0;

e3165: (x1957/(1e-6 + b2093) - 0.9*log(1 + x1925/(1e-6 + b2093)))*(1e-6 + b2093
       ) <= 0;
...
e3174:    x1438 - x1922 - x1926 = 0;

e3175:    x1439 - x1923 - x1927 = 0;

e3176:    x1440 - x1924 - x1928 = 0;

e3177:    x1441 - x1925 - x1929 = 0;

e3178:    x1458 - x1954 - x1958 = 0;

e3179:    x1459 - x1955 - x1959 = 0;

e3180:    x1460 - x1956 - x1960 = 0;

e3181:    x1461 - x1957 - x1961 = 0;

e3182:    x1922 - 0.705049913072943*b2090 <= 0;

e3183:    x1923 - 0.705049913072943*b2091 <= 0;

e3184:    x1924 - 0.705049913072943*b2092 <= 0;

e3185:    x1925 - 0.705049913072943*b2093 <= 0;
...
e3190:    x1954 - 0.480234946352917*b2090 <= 0;

e3191:    x1955 - 0.480234946352917*b2091 <= 0;

e3192:    x1956 - 0.480234946352917*b2092 <= 0;

e3193:    x1957 - 0.480234946352917*b2093 <= 0;
...
e3198: (x1962/(1e-6 + b2094) - log(1 + x1894/(1e-6 + b2094)))*(1e-6 + b2094)
        <= 0;

e3199: (x1963/(1e-6 + b2095) - log(1 + x1895/(1e-6 + b2095)))*(1e-6 + b2095)
        <= 0;

e3200: (x1964/(1e-6 + b2096) - log(1 + x1896/(1e-6 + b2096)))*(1e-6 + b2096)
        <= 0;

e3201: (x1965/(1e-6 + b2097) - log(1 + x1897/(1e-6 + b2097)))*(1e-6 + b2097)
        <= 0;
...
e3210:    x1426 - x1894 - x1902 = 0;

e3211:    x1427 - x1895 - x1903 = 0;

e3212:    x1428 - x1896 - x1904 = 0;

e3213:    x1429 - x1897 - x1905 = 0;

e3214:    x1462 - x1962 - x1966 = 0;

e3215:    x1463 - x1963 - x1967 = 0;

e3216:    x1464 - x1964 - x1968 = 0;

e3217:    x1465 - x1965 - x1969 = 0;

e3218:    x1894 - 0.994083415506506*b2094 <= 0;

e3219:    x1895 - 0.994083415506506*b2095 <= 0;

e3220:    x1896 - 0.994083415506506*b2096 <= 0;

e3221:    x1897 - 0.994083415506506*b2097 <= 0;
...
e3226:    x1962 - 0.690184503917672*b2094 <= 0;

e3227:    x1963 - 0.690184503917672*b2095 <= 0;

e3228:    x1964 - 0.690184503917672*b2096 <= 0;

e3229:    x1965 - 0.690184503917672*b2097 <= 0;
...
e3234:  - 0.9*x1930 + x1970 = 0;

e3235:  - 0.9*x1931 + x1971 = 0;

e3236:  - 0.9*x1932 + x1972 = 0;

e3237:  - 0.9*x1933 + x1973 = 0;
...
e3246:    x1442 - x1930 - x1934 = 0;

e3247:    x1443 - x1931 - x1935 = 0;

e3248:    x1444 - x1932 - x1936 = 0;

e3249:    x1445 - x1933 - x1937 = 0;

e3250:    x1466 - x1970 - x1974 = 0;

e3251:    x1467 - x1971 - x1975 = 0;

e3252:    x1468 - x1972 - x1976 = 0;

e3253:    x1469 - x1973 - x1977 = 0;

e3254:    x1930 - 15*b2098 <= 0;

e3255:    x1931 - 15*b2099 <= 0;

e3256:    x1932 - 15*b2100 <= 0;

e3257:    x1933 - 15*b2101 <= 0;

e3258:    x1934 + 15*b2098 <= 15;

e3259:    x1935 + 15*b2099 <= 15;

e3260:    x1936 + 15*b2100 <= 15;

e3261:    x1937 + 15*b2101 <= 15;

e3262:    x1970 - 13.5*b2098 <= 0;

e3263:    x1971 - 13.5*b2099 <= 0;

e3264:    x1972 - 13.5*b2100 <= 0;

e3265:    x1973 - 13.5*b2101 <= 0;
...
e3270:  - 0.6*x1938 + x1978 = 0;

e3271:  - 0.6*x1939 + x1979 = 0;

e3272:  - 0.6*x1940 + x1980 = 0;

e3273:  - 0.6*x1941 + x1981 = 0;
...
e3282:    x1446 - x1938 - x1942 = 0;

e3283:    x1447 - x1939 - x1943 = 0;

e3284:    x1448 - x1940 - x1944 = 0;

e3285:    x1449 - x1941 - x1945 = 0;

e3286:    x1470 - x1978 - x1982 = 0;

e3287:    x1471 - x1979 - x1983 = 0;

e3288:    x1472 - x1980 - x1984 = 0;

e3289:    x1473 - x1981 - x1985 = 0;

e3290:    x1938 - 15*b2102 <= 0;

e3291:    x1939 - 15*b2103 <= 0;

e3292:    x1940 - 15*b2104 <= 0;

e3293:    x1941 - 15*b2105 <= 0;

e3294:    x1942 + 15*b2102 <= 15;

e3295:    x1943 + 15*b2103 <= 15;

e3296:    x1944 + 15*b2104 <= 15;

e3297:    x1945 + 15*b2105 <= 15;

e3298:    x1978 - 9*b2102 <= 0;

e3299:    x1979 - 9*b2103 <= 0;

e3300:    x1980 - 9*b2104 <= 0;

e3301:    x1981 - 9*b2105 <= 0;

e3302:    x1982 + 9*b2102 <= 9;

e3303:    x1983 + 9*b2103 <= 9;

e3304:    x1984 + 9*b2104 <= 9;

e3305:    x1985 + 9*b2105 <= 9;

e3306:    5*b2106 + x2226 = 0;

e3307:    4*b2107 + x2227 = 0;

e3308:    6*b2108 + x2228 = 0;

e3309:    3*b2109 + x2229 = 0;

e3310:    8*b2110 + x2230 = 0;

e3311:    7*b2111 + x2231 = 0;

e3312:    6*b2112 + x2232 = 0;

e3313:    5*b2113 + x2233 = 0;

e3314:    6*b2114 + x2234 = 0;

e3315:    9*b2115 + x2235 = 0;

e3316:    4*b2116 + x2236 = 0;

e3317:    3*b2117 + x2237 = 0;

e3318:    10*b2118 + x2238 = 0;

e3319:    9*b2119 + x2239 = 0;

e3320:    5*b2120 + x2240 = 0;

e3321:    6*b2121 + x2241 = 0;

e3322:    6*b2122 + x2242 = 0;

e3323:    10*b2123 + x2243 = 0;

e3324:    6*b2124 + x2244 = 0;

e3325:    9*b2125 + x2245 = 0;

e3326:    7*b2126 + x2246 = 0;

e3327:    7*b2127 + x2247 = 0;

e3328:    4*b2128 + x2248 = 0;

e3329:    2*b2129 + x2249 = 0;

e3330:    4*b2130 + x2250 = 0;

e3331:    3*b2131 + x2251 = 0;

e3332:    2*b2132 + x2252 = 0;

e3333:    8*b2133 + x2253 = 0;

e3334:    5*b2134 + x2254 = 0;

e3335:    6*b2135 + x2255 = 0;

e3336:    7*b2136 + x2256 = 0;

e3337:    4*b2137 + x2257 = 0;

e3338:    2*b2138 + x2258 = 0;

e3339:    5*b2139 + x2259 = 0;

e3340:    2*b2140 + x2260 = 0;

e3341:    6*b2141 + x2261 = 0;

e3342:    4*b2142 + x2262 = 0;

e3343:    7*b2143 + x2263 = 0;

e3344:    4*b2144 + x2264 = 0;

e3345:    7*b2145 + x2265 = 0;

e3346:    3*b2146 + x2266 = 0;

e3347:    9*b2147 + x2267 = 0;

e3348:    3*b2148 + x2268 = 0;

e3349:    6*b2149 + x2269 = 0;

e3350:    7*b2150 + x2270 = 0;

e3351:    2*b2151 + x2271 = 0;

e3352:    9*b2152 + x2272 = 0;

e3353:    6*b2153 + x2273 = 0;

e3354:    3*b2154 + x2274 = 0;

e3355:    b2155 + x2275 = 0;

e3356:    9*b2156 + x2276 = 0;

e3357:    10*b2157 + x2277 = 0;

e3358:    2*b2158 + x2278 = 0;

e3359:    6*b2159 + x2279 = 0;

e3360:    3*b2160 + x2280 = 0;

e3361:    7*b2161 + x2281 = 0;

e3362:    4*b2162 + x2282 = 0;

e3363:    8*b2163 + x2283 = 0;

e3364:    b2164 + x2284 = 0;

e3365:    4*b2165 + x2285 = 0;

e3366:    2*b2166 + x2286 = 0;

e3367:    5*b2167 + x2287 = 0;

e3368:    2*b2168 + x2288 = 0;

e3369:    5*b2169 + x2289 = 0;

e3370:    3*b2170 + x2290 = 0;

e3371:    4*b2171 + x2291 = 0;

e3372:    3*b2172 + x2292 = 0;

e3373:    7*b2173 + x2293 = 0;

e3374:    5*b2174 + x2294 = 0;

e3375:    7*b2175 + x2295 = 0;

e3376:    6*b2176 + x2296 = 0;

e3377:    2*b2177 + x2297 = 0;

e3378:    2*b2178 + x2298 = 0;

e3379:    8*b2179 + x2299 = 0;

e3380:    4*b2180 + x2300 = 0;

e3381:    2*b2181 + x2301 = 0;

e3382:    b2182 + x2302 = 0;

e3383:    4*b2183 + x2303 = 0;

e3384:    b2184 + x2304 = 0;

e3385:    b2185 + x2305 = 0;

e3386:    2*b2186 + x2306 = 0;

e3387:    5*b2187 + x2307 = 0;

e3388:    2*b2188 + x2308 = 0;

e3389:    7*b2189 + x2309 = 0;

e3390:    9*b2190 + x2310 = 0;

e3391:    2*b2191 + x2311 = 0;

e3392:    9*b2192 + x2312 = 0;

e3393:    6*b2193 + x2313 = 0;

e3394:    5*b2194 + x2314 = 0;

e3395:    8*b2195 + x2315 = 0;

e3396:    4*b2196 + x2316 = 0;

e3397:    3*b2197 + x2317 = 0;

e3398:    2*b2198 + x2318 = 0;

e3399:    3*b2199 + x2319 = 0;

e3400:    8*b2200 + x2320 = 0;

e3401:    9*b2201 + x2321 = 0;

e3402:    10*b2202 + x2322 = 0;

e3403:    6*b2203 + x2323 = 0;

e3404:    3*b2204 + x2324 = 0;

e3405:    6*b2205 + x2325 = 0;

e3406:    4*b2206 + x2326 = 0;

e3407:    8*b2207 + x2327 = 0;

e3408:    7*b2208 + x2328 = 0;

e3409:    7*b2209 + x2329 = 0;

e3410:    7*b2210 + x2330 = 0;

e3411:    3*b2211 + x2331 = 0;

e3412:    9*b2212 + x2332 = 0;

e3413:    3*b2213 + x2333 = 0;

e3414:    4*b2214 + x2334 = 0;

e3415:    8*b2215 + x2335 = 0;

e3416:    6*b2216 + x2336 = 0;

e3417:    8*b2217 + x2337 = 0;

e3418:    2*b2218 + x2338 = 0;

e3419:    b2219 + x2339 = 0;

e3420:    3*b2220 + x2340 = 0;

e3421:    9*b2221 + x2341 = 0;

e3422:    8*b2222 + x2342 = 0;

e3423:    3*b2223 + x2343 = 0;

e3424:    4*b2224 + x2344 = 0;

e3425:    3*b2225 + x2345 = 0;
...
e3967:  - b1986 + b1987 - b2107 <= 0;

e3968:  - b1986 - b1987 + b1988 - b2108 <= 0;

e3969:  - b1986 - b1987 - b1988 + b1989 - b2109 <= 0;

e3970:    b1990 - b2110 <= 0;

e3971:  - b1990 + b1991 - b2111 <= 0;

e3972:  - b1990 - b1991 + b1992 - b2112 <= 0;

e3973:  - b1990 - b1991 - b1992 + b1993 - b2113 <= 0;

e3974:    b1994 - b2114 <= 0;

e3975:  - b1994 + b1995 - b2115 <= 0;

e3976:  - b1994 - b1995 + b1996 - b2116 <= 0;

e3977:  - b1994 - b1995 - b1996 + b1997 - b2117 <= 0;

e3978:    b1998 - b2118 <= 0;

e3979:  - b1998 + b1999 - b2119 <= 0;

e3980:  - b1998 - b1999 + b2000 - b2120 <= 0;

e3981:  - b1998 - b1999 - b2000 + b2001 - b2121 <= 0;

e3982:    b2002 - b2122 <= 0;

e3983:  - b2002 + b2003 - b2123 <= 0;

e3984:  - b2002 - b2003 + b2004 - b2124 <= 0;

e3985:  - b2002 - b2003 - b2004 + b2005 - b2125 <= 0;

e3986:    b2006 - b2126 <= 0;

e3987:  - b2006 + b2007 - b2127 <= 0;

e3988:  - b2006 - b2007 + b2008 - b2128 <= 0;

e3989:  - b2006 - b2007 - b2008 + b2009 - b2129 <= 0;

e3990:    b2010 - b2130 <= 0;

e3991:  - b2010 + b2011 - b2131 <= 0;

e3992:  - b2010 - b2011 + b2012 - b2132 <= 0;

e3993:  - b2010 - b2011 - b2012 + b2013 - b2133 <= 0;

e3994:    b2014 - b2134 <= 0;

e3995:  - b2014 + b2015 - b2135 <= 0;

e3996:  - b2014 - b2015 + b2016 - b2136 <= 0;

e3997:  - b2014 - b2015 - b2016 + b2017 - b2137 <= 0;

e3998:    b2018 - b2138 <= 0;

e3999:  - b2018 + b2019 - b2139 <= 0;

e4000:  - b2018 - b2019 + b2020 - b2140 <= 0;

e4001:  - b2018 - b2019 - b2020 + b2021 - b2141 <= 0;

e4002:    b2022 - b2142 <= 0;

e4003:  - b2022 + b2023 - b2143 <= 0;

e4004:  - b2022 - b2023 + b2024 - b2144 <= 0;

e4005:  - b2022 - b2023 - b2024 + b2025 - b2145 <= 0;

e4006:    b2026 - b2146 <= 0;

e4007:  - b2026 + b2027 - b2147 <= 0;

e4008:  - b2026 - b2027 + b2028 - b2148 <= 0;

e4009:  - b2026 - b2027 - b2028 + b2029 - b2149 <= 0;

e4010:    b2030 - b2150 <= 0;

e4011:  - b2030 + b2031 - b2151 <= 0;

e4012:  - b2030 - b2031 + b2032 - b2152 <= 0;

e4013:  - b2030 - b2031 - b2032 + b2033 - b2153 <= 0;

e4014:    b2034 - b2154 <= 0;

e4015:  - b2034 + b2035 - b2155 <= 0;

e4016:  - b2034 - b2035 + b2036 - b2156 <= 0;

e4017:  - b2034 - b2035 - b2036 + b2037 - b2157 <= 0;

e4018:    b2038 - b2158 <= 0;

e4019:  - b2038 + b2039 - b2159 <= 0;

e4020:  - b2038 - b2039 + b2040 - b2160 <= 0;

e4021:  - b2038 - b2039 - b2040 + b2041 - b2161 <= 0;

e4022:    b2042 - b2162 <= 0;

e4023:  - b2042 + b2043 - b2163 <= 0;

e4024:  - b2042 - b2043 + b2044 - b2164 <= 0;

e4025:  - b2042 - b2043 - b2044 + b2045 - b2165 <= 0;

e4026:    b2046 - b2166 <= 0;

e4027:  - b2046 + b2047 - b2167 <= 0;

e4028:  - b2046 - b2047 + b2048 - b2168 <= 0;

e4029:  - b2046 - b2047 - b2048 + b2049 - b2169 <= 0;

e4030:    b2050 - b2170 <= 0;

e4031:  - b2050 + b2051 - b2171 <= 0;

e4032:  - b2050 - b2051 + b2052 - b2172 <= 0;

e4033:  - b2050 - b2051 - b2052 + b2053 - b2173 <= 0;

e4034:    b2054 - b2174 <= 0;

e4035:  - b2054 + b2055 - b2175 <= 0;

e4036:  - b2054 - b2055 + b2056 - b2176 <= 0;

e4037:  - b2054 - b2055 - b2056 + b2057 - b2177 <= 0;

e4038:    b2058 - b2178 <= 0;

e4039:  - b2058 + b2059 - b2179 <= 0;

e4040:  - b2058 - b2059 + b2060 - b2180 <= 0;

e4041:  - b2058 - b2059 - b2060 + b2061 - b2181 <= 0;

e4042:    b2062 - b2182 <= 0;

e4043:  - b2062 + b2063 - b2183 <= 0;

e4044:  - b2062 - b2063 + b2064 - b2184 <= 0;

e4045:  - b2062 - b2063 - b2064 + b2065 - b2185 <= 0;

e4046:    b2066 - b2186 <= 0;

e4047:  - b2066 + b2067 - b2187 <= 0;

e4048:  - b2066 - b2067 + b2068 - b2188 <= 0;

e4049:  - b2066 - b2067 - b2068 + b2069 - b2189 <= 0;

e4050:    b2070 - b2190 <= 0;

e4051:  - b2070 + b2071 - b2191 <= 0;

e4052:  - b2070 - b2071 + b2072 - b2192 <= 0;

e4053:  - b2070 - b2071 - b2072 + b2073 - b2193 <= 0;

e4054:    b2074 - b2194 <= 0;

e4055:  - b2074 + b2075 - b2195 <= 0;

e4056:  - b2074 - b2075 + b2076 - b2196 <= 0;

e4057:  - b2074 - b2075 - b2076 + b2077 - b2197 <= 0;

e4058:    b2078 - b2198 <= 0;

e4059:  - b2078 + b2079 - b2199 <= 0;

e4060:  - b2078 - b2079 + b2080 - b2200 <= 0;

e4061:  - b2078 - b2079 - b2080 + b2081 - b2201 <= 0;

e4062:    b2082 - b2202 <= 0;

e4063:  - b2082 + b2083 - b2203 <= 0;

e4064:  - b2082 - b2083 + b2084 - b2204 <= 0;

e4065:  - b2082 - b2083 - b2084 + b2085 - b2205 <= 0;

e4066:    b2086 - b2206 <= 0;

e4067:  - b2086 + b2087 - b2207 <= 0;

e4068:  - b2086 - b2087 + b2088 - b2208 <= 0;

e4069:  - b2086 - b2087 - b2088 + b2089 - b2209 <= 0;

e4070:    b2090 - b2210 <= 0;

e4071:  - b2090 + b2091 - b2211 <= 0;

e4072:  - b2090 - b2091 + b2092 - b2212 <= 0;

e4073:  - b2090 - b2091 - b2092 + b2093 - b2213 <= 0;

e4074:    b2094 - b2214 <= 0;

e4075:  - b2094 + b2095 - b2215 <= 0;

e4076:  - b2094 - b2095 + b2096 - b2216 <= 0;

e4077:  - b2094 - b2095 - b2096 + b2097 - b2217 <= 0;

e4078:    b2098 - b2218 <= 0;

e4079:  - b2098 + b2099 - b2219 <= 0;

e4080:  - b2098 - b2099 + b2100 - b2220 <= 0;

e4081:  - b2098 - b2099 - b2100 + b2101 - b2221 <= 0;

e4082:    b2102 - b2222 <= 0;

e4083:  - b2102 + b2103 - b2223 <= 0;

e4084:  - b2102 - b2103 + b2104 - b2224 <= 0;

e4085:  - b2102 - b2103 - b2104 + b2105 - b2225 <= 0;
...
e4090:  - b1994 + b2006 + b2010 >= 0;

e4091:  - b1995 + b2007 + b2011 >= 0;

e4092:  - b1996 + b2008 + b2012 >= 0;

e4093:  - b1997 + b2009 + b2013 >= 0;
...
e4106:  - b2014 + b2038 + b2042 >= 0;

e4107:  - b2015 + b2039 + b2043 >= 0;

e4108:  - b2016 + b2040 + b2044 >= 0;

e4109:  - b2017 + b2041 + b2045 >= 0;

e4110:  - b2002 + b2018 + b2022 + b2026 >= 0;

e4111:  - b2003 + b2019 + b2023 + b2027 >= 0;

e4112:  - b2004 + b2020 + b2024 + b2028 >= 0;

e4113:  - b2005 + b2021 + b2025 + b2029 >= 0;
...
e4118:  - b2022 + b2046 + b2050 >= 0;

e4119:  - b2023 + b2047 + b2051 >= 0;

e4120:  - b2024 + b2048 + b2052 >= 0;

e4121:  - b2025 + b2049 + b2053 >= 0;

e4122:  - b2026 + b2054 + b2058 + b2062 >= 0;

e4123:  - b2027 + b2055 + b2059 + b2063 >= 0;

e4124:  - b2028 + b2056 + b2060 + b2064 >= 0;

e4125:  - b2029 + b2057 + b2061 + b2065 >= 0;

e4126:    b1986 + b1990 - b1994 >= 0;

e4127:    b1987 + b1991 - b1995 >= 0;

e4128:    b1988 + b1992 - b1996 >= 0;

e4129:    b1989 + b1993 - b1997 >= 0;

e4130:    b1986 + b1990 - b1998 >= 0;

e4131:    b1987 + b1991 - b1999 >= 0;

e4132:    b1988 + b1992 - b2000 >= 0;

e4133:    b1989 + b1993 - b2001 >= 0;

e4134:    b1986 + b1990 - b2002 >= 0;

e4135:    b1987 + b1991 - b2003 >= 0;

e4136:    b1988 + b1992 - b2004 >= 0;

e4137:    b1989 + b1993 - b2005 >= 0;
...
e4198:  - b2062 + b2066 + b2070 >= 0;

e4199:  - b2063 + b2067 + b2071 >= 0;

e4200:  - b2064 + b2068 + b2072 >= 0;

e4201:  - b2065 + b2069 + b2073 >= 0;

e4202:  - b2074 + b2086 + b2090 >= 0;

e4203:  - b2075 + b2087 + b2091 >= 0;

e4204:  - b2076 + b2088 + b2092 >= 0;

e4205:  - b2077 + b2089 + b2093 >= 0;
