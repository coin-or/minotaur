...
maximize obj:  - 4*x2 - 8*x7 - 5*x11 - 8*x23 + 23*x27 + 19*x29 - 10*x30 + 2*x33
     ...
     - 28*b115 - 8*b117 - 15*b118 - 23*b119 + 5*x158 - 2*x163 + 200*x164
     + 250*x165 + 300*x166 - 5*b167 - 8*b168 - 6*b169 - 10*b170 - 6*b171;
...
e264: -log(1 + x153) + x155 + b167 <= 1;

e265:    x153 - 10*b167 <= 0;

e266:    x155 - 2.39789527279837*b167 <= 0;

e267: -1.2*log(1 + x154) + x156 + b168 <= 1;

e268:    x154 - 10*b168 <= 0;

e269:    x156 - 2.87747432735804*b168 <= 0;

e270:  - 0.75*x160 + x164 + b169 <= 1;

e271:  - 0.75*x160 + x164 - b169 >= -1;

e272:    x160 - 2.87747432735804*b169 <= 0;

e273:    x164 - 2.15810574551853*b169 <= 0;

e274: -1.5*log(1 + x161) + x165 + b170 <= 1;

e275:    x161 - 2.87747432735804*b170 <= 0;

e276:    x165 - 2.03277599268042*b170 <= 0;

e277:  - x162 + x166 + b171 <= 1;

e278:  - x162 + x166 - b171 >= -1;

e279:  - 0.5*x163 + x166 + b171 <= 1;

e280:  - 0.5*x163 + x166 - b171 >= -1;

e281:    x162 - 2.87747432735804*b171 <= 0;

e282:    x163 - 7*b171 <= 0;

e283:    x166 - 3.5*b171 <= 0;

e284:    b167 + b168 = 1;

e285:    b167 + b168 - b169 >= 0;

e286:    b167 + b168 - b170 >= 0;

e287:    b167 + b168 - b171 >= 0;
