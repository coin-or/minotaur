...
minimize obj: (log(x2) - log(x2 + x4))*x2 + (log(x4) - log(x2 + x4))*x4 + (log(
    x3) - log(x3 + x5))*x3 + (log(x5) - log(x3 + x5))*x5 + 0.925356626778358*x2
    *x8 + 0.746014540096753*x4*x6 + 0.925356626778358*x3*x9 + 0.746014540096753
    *x5*x7;
