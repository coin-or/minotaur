...
minimize obj: log(x2)*x2 + log(x3)*x3 + log(x4)*x4 - log(x5 - x7) + x5 - 
    0.353553390593274*log((x5 + 2.41421356237309*x7)/(x5 - 0.414213562373095*x7
    ))*x6/x7 + 1.42876598488588*x2 + 1.27098480432594*x3 + 1.62663700075562*x4
     - 1;

subject to

e2: x5^3 - x5^2*(1 - x7) + (-3*x7^2 - 2*x7 + x6)*x5 - x6*x7 + x7^3 + x7^2 = 0;
