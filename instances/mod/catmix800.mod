#  NLP written by GAMS Convert at 01/12/18 13:30:06
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
minimize obj:    x1602 + x2403 - 1;

subject to

e2: x803 - (0.000625*(x1*(10*x1603 - x802) + x2*(10*x1604 - x803)) + x802) = 0;

e3: x804 - (0.000625*(x2*(10*x1604 - x803) + x3*(10*x1605 - x804)) + x803) = 0;

e4: x805 - (0.000625*(x3*(10*x1605 - x804) + x4*(10*x1606 - x805)) + x804) = 0;

e5: x806 - (0.000625*(x4*(10*x1606 - x805) + x5*(10*x1607 - x806)) + x805) = 0;

e6: x807 - (0.000625*(x5*(10*x1607 - x806) + x6*(10*x1608 - x807)) + x806) = 0;

e7: x808 - (0.000625*(x6*(10*x1608 - x807) + x7*(10*x1609 - x808)) + x807) = 0;

e8: x809 - (0.000625*(x7*(10*x1609 - x808) + x8*(10*x1610 - x809)) + x808) = 0;

e9: x810 - (0.000625*(x8*(10*x1610 - x809) + x9*(10*x1611 - x810)) + x809) = 0;
...
e101: x902 - (0.000625*(x100*(10*x1702 - x901) + x101*(10*x1703 - x902)) + x901
      ) = 0;

e102: x903 - (0.000625*(x101*(10*x1703 - x902) + x102*(10*x1704 - x903)) + x902
      ) = 0;

e103: x904 - (0.000625*(x102*(10*x1704 - x903) + x103*(10*x1705 - x904)) + x903
      ) = 0;

e104: x905 - (0.000625*(x103*(10*x1705 - x904) + x104*(10*x1706 - x905)) + x904
      ) = 0;

e105: x906 - (0.000625*(x104*(10*x1706 - x905) + x105*(10*x1707 - x906)) + x905
      ) = 0;

e106: x907 - (0.000625*(x105*(10*x1707 - x906) + x106*(10*x1708 - x907)) + x906
      ) = 0;

e107: x908 - (0.000625*(x106*(10*x1708 - x907) + x107*(10*x1709 - x908)) + x907
      ) = 0;

e108: x909 - (0.000625*(x107*(10*x1709 - x908) + x108*(10*x1710 - x909)) + x908
      ) = 0;

e109: x910 - (0.000625*(x108*(10*x1710 - x909) + x109*(10*x1711 - x910)) + x909
      ) = 0;

e110: x911 - (0.000625*(x109*(10*x1711 - x910) + x110*(10*x1712 - x911)) + x910
      ) = 0;

e111: x912 - (0.000625*(x110*(10*x1712 - x911) + x111*(10*x1713 - x912)) + x911
      ) = 0;

e112: x913 - (0.000625*(x111*(10*x1713 - x912) + x112*(10*x1714 - x913)) + x912
      ) = 0;

e113: x914 - (0.000625*(x112*(10*x1714 - x913) + x113*(10*x1715 - x914)) + x913
      ) = 0;

e114: x915 - (0.000625*(x113*(10*x1715 - x914) + x114*(10*x1716 - x915)) + x914
      ) = 0;

e115: x916 - (0.000625*(x114*(10*x1716 - x915) + x115*(10*x1717 - x916)) + x915
      ) = 0;

e116: x917 - (0.000625*(x115*(10*x1717 - x916) + x116*(10*x1718 - x917)) + x916
      ) = 0;

e117: x918 - (0.000625*(x116*(10*x1718 - x917) + x117*(10*x1719 - x918)) + x917
      ) = 0;

e118: x919 - (0.000625*(x117*(10*x1719 - x918) + x118*(10*x1720 - x919)) + x918
      ) = 0;

e119: x920 - (0.000625*(x118*(10*x1720 - x919) + x119*(10*x1721 - x920)) + x919
      ) = 0;

e120: x921 - (0.000625*(x119*(10*x1721 - x920) + x120*(10*x1722 - x921)) + x920
      ) = 0;

e121: x922 - (0.000625*(x120*(10*x1722 - x921) + x121*(10*x1723 - x922)) + x921
      ) = 0;

e122: x923 - (0.000625*(x121*(10*x1723 - x922) + x122*(10*x1724 - x923)) + x922
      ) = 0;

e123: x924 - (0.000625*(x122*(10*x1724 - x923) + x123*(10*x1725 - x924)) + x923
      ) = 0;

e124: x925 - (0.000625*(x123*(10*x1725 - x924) + x124*(10*x1726 - x925)) + x924
      ) = 0;

e125: x926 - (0.000625*(x124*(10*x1726 - x925) + x125*(10*x1727 - x926)) + x925
      ) = 0;

e126: x927 - (0.000625*(x125*(10*x1727 - x926) + x126*(10*x1728 - x927)) + x926
      ) = 0;

e127: x928 - (0.000625*(x126*(10*x1728 - x927) + x127*(10*x1729 - x928)) + x927
      ) = 0;

e128: x929 - (0.000625*(x127*(10*x1729 - x928) + x128*(10*x1730 - x929)) + x928
      ) = 0;

e129: x930 - (0.000625*(x128*(10*x1730 - x929) + x129*(10*x1731 - x930)) + x929
      ) = 0;

e130: x931 - (0.000625*(x129*(10*x1731 - x930) + x130*(10*x1732 - x931)) + x930
      ) = 0;

e131: x932 - (0.000625*(x130*(10*x1732 - x931) + x131*(10*x1733 - x932)) + x931
      ) = 0;

e132: x933 - (0.000625*(x131*(10*x1733 - x932) + x132*(10*x1734 - x933)) + x932
      ) = 0;

e133: x934 - (0.000625*(x132*(10*x1734 - x933) + x133*(10*x1735 - x934)) + x933
      ) = 0;

e134: x935 - (0.000625*(x133*(10*x1735 - x934) + x134*(10*x1736 - x935)) + x934
      ) = 0;

e135: x936 - (0.000625*(x134*(10*x1736 - x935) + x135*(10*x1737 - x936)) + x935
      ) = 0;

e136: x937 - (0.000625*(x135*(10*x1737 - x936) + x136*(10*x1738 - x937)) + x936
      ) = 0;

e137: x938 - (0.000625*(x136*(10*x1738 - x937) + x137*(10*x1739 - x938)) + x937
      ) = 0;

e138: x939 - (0.000625*(x137*(10*x1739 - x938) + x138*(10*x1740 - x939)) + x938
      ) = 0;

e139: x940 - (0.000625*(x138*(10*x1740 - x939) + x139*(10*x1741 - x940)) + x939
      ) = 0;

e140: x941 - (0.000625*(x139*(10*x1741 - x940) + x140*(10*x1742 - x941)) + x940
      ) = 0;

e141: x942 - (0.000625*(x140*(10*x1742 - x941) + x141*(10*x1743 - x942)) + x941
      ) = 0;

e142: x943 - (0.000625*(x141*(10*x1743 - x942) + x142*(10*x1744 - x943)) + x942
      ) = 0;

e143: x944 - (0.000625*(x142*(10*x1744 - x943) + x143*(10*x1745 - x944)) + x943
      ) = 0;

e144: x945 - (0.000625*(x143*(10*x1745 - x944) + x144*(10*x1746 - x945)) + x944
      ) = 0;

e145: x946 - (0.000625*(x144*(10*x1746 - x945) + x145*(10*x1747 - x946)) + x945
      ) = 0;

e146: x947 - (0.000625*(x145*(10*x1747 - x946) + x146*(10*x1748 - x947)) + x946
      ) = 0;

e147: x948 - (0.000625*(x146*(10*x1748 - x947) + x147*(10*x1749 - x948)) + x947
      ) = 0;

e148: x949 - (0.000625*(x147*(10*x1749 - x948) + x148*(10*x1750 - x949)) + x948
      ) = 0;

e149: x950 - (0.000625*(x148*(10*x1750 - x949) + x149*(10*x1751 - x950)) + x949
      ) = 0;

e150: x951 - (0.000625*(x149*(10*x1751 - x950) + x150*(10*x1752 - x951)) + x950
      ) = 0;

e151: x952 - (0.000625*(x150*(10*x1752 - x951) + x151*(10*x1753 - x952)) + x951
      ) = 0;

e152: x953 - (0.000625*(x151*(10*x1753 - x952) + x152*(10*x1754 - x953)) + x952
      ) = 0;

e153: x954 - (0.000625*(x152*(10*x1754 - x953) + x153*(10*x1755 - x954)) + x953
      ) = 0;

e154: x955 - (0.000625*(x153*(10*x1755 - x954) + x154*(10*x1756 - x955)) + x954
      ) = 0;

e155: x956 - (0.000625*(x154*(10*x1756 - x955) + x155*(10*x1757 - x956)) + x955
      ) = 0;

e156: x957 - (0.000625*(x155*(10*x1757 - x956) + x156*(10*x1758 - x957)) + x956
      ) = 0;

e157: x958 - (0.000625*(x156*(10*x1758 - x957) + x157*(10*x1759 - x958)) + x957
      ) = 0;

e158: x959 - (0.000625*(x157*(10*x1759 - x958) + x158*(10*x1760 - x959)) + x958
      ) = 0;

e159: x960 - (0.000625*(x158*(10*x1760 - x959) + x159*(10*x1761 - x960)) + x959
      ) = 0;

e160: x961 - (0.000625*(x159*(10*x1761 - x960) + x160*(10*x1762 - x961)) + x960
      ) = 0;

e161: x962 - (0.000625*(x160*(10*x1762 - x961) + x161*(10*x1763 - x962)) + x961
      ) = 0;

e162: x963 - (0.000625*(x161*(10*x1763 - x962) + x162*(10*x1764 - x963)) + x962
      ) = 0;

e163: x964 - (0.000625*(x162*(10*x1764 - x963) + x163*(10*x1765 - x964)) + x963
      ) = 0;

e164: x965 - (0.000625*(x163*(10*x1765 - x964) + x164*(10*x1766 - x965)) + x964
      ) = 0;

e165: x966 - (0.000625*(x164*(10*x1766 - x965) + x165*(10*x1767 - x966)) + x965
      ) = 0;

e166: x967 - (0.000625*(x165*(10*x1767 - x966) + x166*(10*x1768 - x967)) + x966
      ) = 0;

e167: x968 - (0.000625*(x166*(10*x1768 - x967) + x167*(10*x1769 - x968)) + x967
      ) = 0;

e168: x969 - (0.000625*(x167*(10*x1769 - x968) + x168*(10*x1770 - x969)) + x968
      ) = 0;

e169: x970 - (0.000625*(x168*(10*x1770 - x969) + x169*(10*x1771 - x970)) + x969
      ) = 0;

e170: x971 - (0.000625*(x169*(10*x1771 - x970) + x170*(10*x1772 - x971)) + x970
      ) = 0;

e171: x972 - (0.000625*(x170*(10*x1772 - x971) + x171*(10*x1773 - x972)) + x971
      ) = 0;

e172: x973 - (0.000625*(x171*(10*x1773 - x972) + x172*(10*x1774 - x973)) + x972
      ) = 0;

e173: x974 - (0.000625*(x172*(10*x1774 - x973) + x173*(10*x1775 - x974)) + x973
      ) = 0;

e174: x975 - (0.000625*(x173*(10*x1775 - x974) + x174*(10*x1776 - x975)) + x974
      ) = 0;

e175: x976 - (0.000625*(x174*(10*x1776 - x975) + x175*(10*x1777 - x976)) + x975
      ) = 0;

e176: x977 - (0.000625*(x175*(10*x1777 - x976) + x176*(10*x1778 - x977)) + x976
      ) = 0;

e177: x978 - (0.000625*(x176*(10*x1778 - x977) + x177*(10*x1779 - x978)) + x977
      ) = 0;

e178: x979 - (0.000625*(x177*(10*x1779 - x978) + x178*(10*x1780 - x979)) + x978
      ) = 0;

e179: x980 - (0.000625*(x178*(10*x1780 - x979) + x179*(10*x1781 - x980)) + x979
      ) = 0;

e180: x981 - (0.000625*(x179*(10*x1781 - x980) + x180*(10*x1782 - x981)) + x980
      ) = 0;

e181: x982 - (0.000625*(x180*(10*x1782 - x981) + x181*(10*x1783 - x982)) + x981
      ) = 0;

e182: x983 - (0.000625*(x181*(10*x1783 - x982) + x182*(10*x1784 - x983)) + x982
      ) = 0;

e183: x984 - (0.000625*(x182*(10*x1784 - x983) + x183*(10*x1785 - x984)) + x983
      ) = 0;

e184: x985 - (0.000625*(x183*(10*x1785 - x984) + x184*(10*x1786 - x985)) + x984
      ) = 0;

e185: x986 - (0.000625*(x184*(10*x1786 - x985) + x185*(10*x1787 - x986)) + x985
      ) = 0;

e186: x987 - (0.000625*(x185*(10*x1787 - x986) + x186*(10*x1788 - x987)) + x986
      ) = 0;

e187: x988 - (0.000625*(x186*(10*x1788 - x987) + x187*(10*x1789 - x988)) + x987
      ) = 0;

e188: x989 - (0.000625*(x187*(10*x1789 - x988) + x188*(10*x1790 - x989)) + x988
      ) = 0;

e189: x990 - (0.000625*(x188*(10*x1790 - x989) + x189*(10*x1791 - x990)) + x989
      ) = 0;

e190: x991 - (0.000625*(x189*(10*x1791 - x990) + x190*(10*x1792 - x991)) + x990
      ) = 0;

e191: x992 - (0.000625*(x190*(10*x1792 - x991) + x191*(10*x1793 - x992)) + x991
      ) = 0;

e192: x993 - (0.000625*(x191*(10*x1793 - x992) + x192*(10*x1794 - x993)) + x992
      ) = 0;

e193: x994 - (0.000625*(x192*(10*x1794 - x993) + x193*(10*x1795 - x994)) + x993
      ) = 0;

e194: x995 - (0.000625*(x193*(10*x1795 - x994) + x194*(10*x1796 - x995)) + x994
      ) = 0;

e195: x996 - (0.000625*(x194*(10*x1796 - x995) + x195*(10*x1797 - x996)) + x995
      ) = 0;

e196: x997 - (0.000625*(x195*(10*x1797 - x996) + x196*(10*x1798 - x997)) + x996
      ) = 0;

e197: x998 - (0.000625*(x196*(10*x1798 - x997) + x197*(10*x1799 - x998)) + x997
      ) = 0;

e198: x999 - (0.000625*(x197*(10*x1799 - x998) + x198*(10*x1800 - x999)) + x998
      ) = 0;
