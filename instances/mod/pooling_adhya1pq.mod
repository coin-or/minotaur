...
e17:  - 3*x16 - x28 - 3*x32 <= 0;

e18:    3.5*x16 - 1.5*x20 + 3*x24 + 0.5*x28 + 0.2*x32 <= 0;

e19:    0.5*x16 - 0.5*x20 - 0.5*x24 - 0.5*x28 + 0.5*x32 <= 0;

e20:  - x16 + 0.5*x20 - 0.6*x24 - 0.5*x28 + 0.1*x32 <= 0;

e21:  - 0.5*x17 + 2.5*x21 + 2.5*x25 + 1.5*x29 - 0.5*x33 <= 0;

e22:    0.5*x17 - 4.5*x21 - 2.5*x29 - 2.8*x33 <= 0;

e23:    0.1*x17 - 0.9*x21 - 0.9*x25 - 0.9*x29 + 0.1*x33 <= 0;

e24:  - 0.3*x17 + 1.2*x21 + 0.1*x25 + 0.2*x29 + 0.8*x33 <= 0;

e25:  - 2*x18 + x22 + x26 - 2*x34 <= 0;

e26:    2*x18 - 3*x22 + 1.5*x26 - x30 - 1.3*x34 <= 0;

e27:  - x22 - x26 - x30 <= 0;

e28:  - 1.3*x18 + 0.2*x22 - 0.9*x26 - 0.8*x30 - 0.2*x34 <= 0;
