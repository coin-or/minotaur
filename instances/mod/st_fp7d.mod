...
minimize obj: 8*x1 - 0.5*x1^2 - 0.5*x2^2 + 8*x2 - 0.5*x3^2 + 8*x3 - 0.5*x4^2 + 
    8*x4 - 0.5*x5^2 + 8*x5 - 0.5*x6^2 + 8*x6 - 0.5*x7^2 + 8*x7 - 0.5*x8^2 + 8*
    x8 - 0.5*x9^2 + 8*x9 - 0.5*x10^2 + 8*x10 - 0.5*x11^2 + 8*x11 - 0.5*x12^2 + 
    8*x12 - 0.5*x13^2 + 8*x13 - 0.5*x14^2 + 8*x14 - 0.5*x15^2 + 8*x15 - 0.5*x16
    ^2 + 8*x16 - 0.5*x17^2 + 8*x17 - 0.5*x18^2 + 8*x18 - 0.5*x19^2 + 8*x19 - 
    0.5*x20^2 + 8*x20;
