...
minimize obj: 2*x1 - 0.5*x1^2 - x2^2 + 4*x2 - 1.5*x3^2 + 6*x3 - 2*x4^2 + 8*x4
     - 2.5*x5^2 + 10*x5 - 3*x6^2 + 12*x6 - 3.5*x7^2 + 14*x7 - 4*x8^2 + 16*x8 - 
    4.5*x9^2 + 18*x9 - 5*x10^2 + 20*x10 - 5.5*x11^2 + 22*x11 - 6*x12^2 + 24*x12
     - 6.5*x13^2 + 26*x13 - 7*x14^2 + 28*x14 - 7.5*x15^2 + 30*x15 - 8*x16^2 + 
    32*x16 - 8.5*x17^2 + 34*x17 - 9*x18^2 + 36*x18 - 9.5*x19^2 + 38*x19 - 10*
    x20^2 + 40*x20;
