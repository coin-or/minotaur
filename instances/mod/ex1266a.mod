...
var i1 integer := 1, >= 0, <= 5;
var i2 integer >= 0, <= 5;
var i3 integer >= 0, <= 5;
var i4 integer >= 0, <= 5;
var i5 integer >= 0, <= 5;
var i6 integer >= 0, <= 5;
var i7 integer := 2, >= 0, <= 5;
var i8 integer >= 0, <= 5;
var i9 integer >= 0, <= 5;
var i10 integer >= 0, <= 5;
var i11 integer >= 0, <= 5;
...
var b41 binary >= 0, <= 1;
var b42 binary >= 0, <= 1;
var i43 integer := 8, >= 0, <= 15;
var i44 integer := 7, >= 0, <= 12;
var i45 integer >= 0, <= 8;
var i46 integer >= 0, <= 7;
var i47 integer >= 0, <= 4;
var i48 integer >= 0, <= 2;

minimize obj:    0.1*b37 + 0.2*b38 + 0.3*b39 + 0.4*b40 + 0.5*b41 + i43 + i44
     + i45 + i46 + i47 + i48;
