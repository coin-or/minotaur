...
minimize obj: 2*x1 - 0.5*x1^2 - 0.5*x2^2 + 2*x2 - 0.5*x3^2 + 2*x3 - 0.5*x4^2 + 
    2*x4 - 0.5*x5^2 + 2*x5 - 0.5*x6^2 + 2*x6 - 0.5*x7^2 + 2*x7 - 0.5*x8^2 + 2*
    x8 - 0.5*x9^2 + 2*x9 - 0.5*x10^2 + 2*x10 - 0.5*x11^2 + 2*x11 - 0.5*x12^2 + 
    2*x12 - 0.5*x13^2 + 2*x13 - 0.5*x14^2 + 2*x14 - 0.5*x15^2 + 2*x15 - 0.5*x16
    ^2 + 2*x16 - 0.5*x17^2 + 2*x17 - 0.5*x18^2 + 2*x18 - 0.5*x19^2 + 2*x19 - 
    0.5*x20^2 + 2*x20;
