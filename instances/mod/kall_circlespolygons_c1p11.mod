...
e16:    0.05*x2 + 0.075*x3 + x31 - x39 = 0;

e17:  - 0.05*x2 + 0.075*x3 + x33 - x39 = 0;

e18:  - 0.05*x2 - 0.075*x3 + x35 - x39 = 0;

e19:    0.05*x2 - 0.075*x3 + x37 - x39 = 0;

e20:  - 0.075*x2 + 0.05*x3 + x32 - x40 = 0;

e21:  - 0.075*x2 - 0.05*x3 + x34 - x40 = 0;

e22:    0.075*x2 - 0.05*x3 + x36 - x40 = 0;

e23:    0.075*x2 + 0.05*x3 + x38 - x40 = 0;
