...
minimize obj: 0.5*(42*(52 + x11)^2 + 98*(3 + x12)^2 + 48*(-81 + x13)^2 + 91*(-
    30 + x14)^2 + 11*(85 + x15)^2 + 63*(-68 + x16)^2 + 61*(-27 + x17)^2 + 61*(
    81 + x18)^2 + 38*(-97 + x19)^2 + 26*(73 + x20)^2) - 0.5*(63*(19 + x1)^2 + 
    15*(27 + x2)^2 + 44*(23 + x3)^2 + 91*(53 + x4)^2 + 45*(42 + x5)^2 + 50*(-26
     + x6)^2 + 89*(33 + x7)^2 + 58*(23 + x8)^2 + 86*(-41 + x9)^2 + 82*(-19 + 
    x10)^2);
