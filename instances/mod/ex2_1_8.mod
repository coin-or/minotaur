#  NLP written by GAMS Convert at 01/12/18 13:31:54
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         11       11        0        0        0        0        0        0
...
minimize obj: 300*x1 - 7*x1*x1 - 4*x2*x2 + 270*x2 - 6*x3*x3 + 460*x3 - 8*x4*x4
     + 800*x4 - 12*x5*x5 + 740*x5 - 9*x6*x6 + 600*x6 - 14*x7*x7 + 540*x7 - 7*x8
    *x8 + 380*x8 - 13*x9*x9 + 300*x9 - 12*x10*x10 + 490*x10 - 8*x11*x11 + 380*
    x11 - 4*x12*x12 + 760*x12 - 7*x13*x13 + 430*x13 - 9*x14*x14 + 250*x14 - 16*
