...
minimize obj: -0.5*((-2 + x1)^2 + 2*(-2 + x2)^2 + 3*(-2 + x3)^2 + 4*(-2 + x4)^2
     + 5*(-2 + x5)^2 + 6*(-2 + x6)^2 + 7*(-2 + x7)^2 + 8*(-2 + x8)^2 + 9*(-2 + 
    x9)^2 + 10*(-2 + x10)^2 + 11*(-2 + x11)^2 + 12*(-2 + x12)^2 + 13*(-2 + x13)
    ^2 + 14*(-2 + x14)^2 + 15*(-2 + x15)^2 + 16*(-2 + x16)^2 + 17*(-2 + x17)^2
     + 18*(-2 + x18)^2 + 19*(-2 + x19)^2 + 20*(-2 + x20)^2);
