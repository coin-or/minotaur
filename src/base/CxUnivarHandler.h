...
protected:
  ...
  /// This should be a pointer to the `original' variable, look at corresponding
  //  bounds in the relaxation to get bounds
...
public:
  ...
  // Creates and adds the secant inequality defined by current constraint to the
  // relaxation
...
typedef boost::shared_ptr<const CxUnivarConstraintData> CxUnivarConstConstraintDataPtr;
