 ...
 */
class QGHandlerPDE : public Handler {
...
public:
   ...
   */
  QGHandlerPDE(EnvPtr env, ProblemPtr minlp, EnginePtr lpe); 
...
private:
 ...
 /**
  ...
  int OAFromPoint_(const double *x, SeparationStatus *status);
  ...
  typedef boost::shared_ptr <QGHandlerPDE> QGHandlerPDEPtr;
}
