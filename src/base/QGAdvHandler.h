...
#ifndef MINOTAURQGADVHANDLER_H
#define MINOTAURQGADVHANDLER_H
 ...
 * algorithm.
 *
 * QGAdvHandler is a derived class of Handler. It adds cuts generated by solving
 ...
 */
class QGAdvHandler : public Handler {
...
private:
  ...
  /**
   *  Status whether problem in amenable to perspective reformulation (PR).
   *  1 if  amenable to PR, otherwise 0.
   */
  bool prStatus_;

  /// Pointer to handle perspective amenable constraints
  PerspCutHandlerPtr pcPtr_;
...
public:
   ...
   */
  QGAdvHandler(EnvPtr env, ProblemPtr minlp, EnginePtr nlpe);
   
  QGAdvHandler(EnvPtr env, ProblemPtr minlp, EnginePtr nlpe,
            PerspCutHandlerPtr pcHand);
