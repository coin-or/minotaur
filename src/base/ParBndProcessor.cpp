 ...
 * \brief Implement simple node-processor for parallel branch-and-bound
...
const std::string ParBndProcessor::me_ = "ParBndProcessor: ";
...
ParBndProcessor::ParBndProcessor (EnvPtr env, EnginePtr engine,
...
bool ParBndProcessor::foundNewSolution()
{
  return (numSolutions_ > 0);
}


Branches ParBndProcessor::getBranches()
{
  ++stats_.bra;
  return branches_;
}
...
bool ParBndProcessor::isFeasible_(NodePtr node, ConstSolutionPtr sol, 
...
void ParBndProcessor::process(NodePtr node, RelaxationPtr rel,
                          SolutionPoolPtr s_pool)
{
  process(node, rel, s_pool, false);
}
...
bool ParBndProcessor::shouldPrune_(NodePtr node, double solval, 
                               SolutionPoolPtr s_pool)
{
...
void ParBndProcessor::solveRelaxation_() 
{
...
void ParBndProcessor::writeStats(std::ostream &out) const
{
...
void ParBndProcessor::writeStats() const
{
