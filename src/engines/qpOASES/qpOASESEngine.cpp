...
//
//     (C)opyright 2011 - 2013 The MINOTAUR Team.
//
	...
	n_changed_ (0)
{
	...
	logger_ = (LoggerPtr) new Logger (
		(LogLevel) (env->getOptions ()->findInt ("bqpd_log_level")->getValue ())
	);
...
void
qpOASESEngine::load (ProblemPtr problem)
{
	problem_ = problem;
	consModed_ = true;
	hessModed_ = true;
...
void
qpOASESEngine::solve_ (Int mode, Double *f)
{
...
void
qpOASESEngine::storeSol_ (Double f)
{
	UInt n = data_->n;
...
void
qpOASESEngine::setInitialPoint_ ()
{
...
Double
qpOASESEngine::getSolutionValue ()
{
...
void
qpOASESEngine::changeBound (ConstraintPtr, BoundType, Double)
{
...
void
qpOASESEngine::changeBound (VariablePtr vPtr, BoundType lu, Double new_val)
{
	if (data_ == 0) return;
...
void
qpOASESEngine::changeBound (VariablePtr, Double, Double)
{
	// empty
...
void
qpOASESEngine::changeObj (FunctionPtr, Double)
{
	// TODO: This will trigger mode 0, is that necessary?
	consModed_ = true;
}
...
void
qpOASESEngine::changeConstraint (ConstraintPtr, LinearFunctionPtr,
                                 const Double & )
{
	// TODO: This will trigger mode 0, is that necessary?
	consModed_ = true;
...
void
qpOASESEngine::enableStrBrSetup ()
{
	strBr_ = true;
}
...
void
qpOASESEngine::disableStrBrSetup()
{
	strBr_ = false;
}
...
void
qpOASESEngine::setIterationLimit(Int)
{
...
void
qpOASESEngine::resetIterationLimit ()
{
...
std::string
qpOASESEngine::getName() const
{
	return "qpOASES";
}

ConstWarmStartPtr
qpOASESEngine::getWarmStart ()
{
	qpOASESWarmStart ws;
...
WarmStartPtr
qpOASESEngine::getWarmStartCopy ()
{
...
void
qpOASESEngine::loadFromWarmStart(WarmStartPtr wp)
{
...
void
qpOASESEngine::savePoint (qpOASESPoint *pt)
{	
...
void
qpOASESEngine::restorePoint (qpOASESPoint *pt)
{
