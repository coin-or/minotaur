...
namespace Minotaur {
  ...
  public:
    ...
    /// Constructor.
    SimpleTransformer(EnvPtr env, ConstProblemPtr p, EnginePtr nlp_e);
  ...
  private:
     ...
     */
    bool checkQuadConvexity_(bool& addCxqHandler);
    ...
    void refQuadCons_(QuadraticFunctionPtr qf, double lb, double ub, LinearFunctionPtr &lf);
